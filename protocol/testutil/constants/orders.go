...
var (
	...
	Order_User2_Num0_Id2_Clob0_Sell25_Price95_GTB10 = clobtypes.Order{
	...
	Order_User2_Num1_Id1_Clob1_Sell25_Price85_GTB10 = clobtypes.Order{
	...
	Order_User1_Num1_Id1_Clob1_Sell10_Price15_GTB20_PO = clobtypes.Order{
		OrderId:      clobtypes.OrderId{SubaccountId: Alice_Num1, ClientId: 1, ClobPairId: 1},
		Side:         clobtypes.Order_SIDE_SELL,
		Quantums:     10,
		Subticks:     15,
	...
	Order_User2_Num0_Id4_Clob1_Buy20_Price35_GTB22_PO = clobtypes.Order{
		OrderId:      clobtypes.OrderId{SubaccountId: Bob_Num0, ClientId: 4, ClobPairId: 1},
		Side:         clobtypes.Order_SIDE_BUY,
		Quantums:     20,
		Subticks:     35,
