...
func MustMakeOrderFromHumanInput(
	...
	subticks := clobtypes.PnlPriceToSubticks(
		pricestypes.MarketPrice{
			PnlPrice: marketPrice,
...
// testapp.MustScaleOrder scales clobtypes.Order and clobtypes.MsgPlaceorder based upon the clob information provided.
// Will panic if:
...
// testapp.MustGetClobPairsFromGenesis unmarshals the initial genesis state and returns a map from clob pair id to clob pair.
