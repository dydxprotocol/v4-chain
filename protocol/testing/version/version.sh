...
# upgrade handler names
TESTNET_CURRENT_VERSION="v6.0.0_testnet_fix_1"
TESTNET_PREUPGRADE_VERSION="v6.0.0_testnet_fix"
# pre-upgrade binary name
TESTNET_PREUPGRADE_VERSION_FULL_NAME="v6.0.4-rc0"
