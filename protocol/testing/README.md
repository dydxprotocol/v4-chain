...
Run the `./build-push-ecr.sh` script in this directory from this repository's root directory. You can specify either the "dev", "dev2", "dev3", "dev5", or "staging" environment.
