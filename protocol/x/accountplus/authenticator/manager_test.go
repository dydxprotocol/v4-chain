...
func (m MockAuthenticator) OnAuthenticatorRemoved(
	ctx sdk.Context,
...
func (m MockAuthenticator) OnAuthenticatorAdded(
	ctx sdk.Context,
	account sdk.AccAddress,
	config []byte,
	authenticatorId string,
...
func (m MockAuthenticatorFail) OnAuthenticatorRemoved(
	ctx sdk.Context,
	account sdk.AccAddress,
	config []byte,
	authenticatorId string,
...
func (m MockAuthenticatorFail) OnAuthenticatorAdded(
	ctx sdk.Context,
	account sdk.AccAddress,
	config []byte,
	authenticatorId string,
