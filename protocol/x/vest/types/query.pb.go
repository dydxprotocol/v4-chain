...
// source: klyraprotocol/vest/query.proto
...
func (*QueryVestEntryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_efd0bd45f6bcf9eb, []int{0}
}
...
func (*QueryVestEntryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_efd0bd45f6bcf9eb, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryVestEntryRequest)(nil), "klyraprotocol.vest.QueryVestEntryRequest")
	proto.RegisterType((*QueryVestEntryResponse)(nil), "klyraprotocol.vest.QueryVestEntryResponse")
}

func init() { proto.RegisterFile("klyraprotocol/vest/query.proto", fileDescriptor_efd0bd45f6bcf9eb) }

var fileDescriptor_efd0bd45f6bcf9eb = []byte{
	...
	,
}
...
func (c *queryClient) VestEntry(ctx context.Context, in *QueryVestEntryRequest, opts ...grpc.CallOption) (*QueryVestEntryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/klyraprotocol.vest.Query/VestEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_VestEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/klyraprotocol.vest.Query/VestEntry",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "klyraprotocol.vest.Query",
	...
	Metadata: "klyraprotocol/vest/query.proto",
}
