...
type AffiliateParameters struct {
	...
	Maximum_30DCommissionPerReferredQuoteQuantums uint64 `protobuf:"varint,1,opt,name=maximum_30d_commission_per_referred_quote_quantums,json=maximum30dCommissionPerReferredQuoteQuantums,proto3" json:"maximum_30d_commission_per_referred_quote_quantums,omitempty"`
	...
	// revenue
	Maximum_30DAttributableRevenuePerAffiliateQuoteQuantums uint64 `protobuf:"varint,3,opt,name=maximum_30d_attributable_revenue_per_affiliate_quote_quantums,json=maximum30dAttributableRevenuePerAffiliateQuoteQuantums,proto3" json:"maximum_30d_attributable_revenue_per_affiliate_quote_quantums,omitempty"`
}
...
func (m *AffiliateParameters) GetMaximum_30DCommissionPerReferredQuoteQuantums() uint64 {
	if m != nil {
		return m.Maximum_30DCommissionPerReferredQuoteQuantums
	}
	return 0
}
...
func (m *AffiliateParameters) GetMaximum_30DAttributableRevenuePerAffiliateQuoteQuantums() uint64 {
	if m != nil {
		return m.Maximum_30DAttributableRevenuePerAffiliateQuoteQuantums
	}
	return 0
}
...
var fileDescriptor_7de5ba9c426e9350 = []byte{
	...
	,
}
...
func (m *AffiliateParameters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.Maximum_30DAttributableRevenuePerAffiliateQuoteQuantums != 0 {
		i = encodeVarintAffiliates(dAtA, i, uint64(m.Maximum_30DAttributableRevenuePerAffiliateQuoteQuantums))
		i--
		dAtA[i] = 0x18
	}
	...
	if m.Maximum_30DCommissionPerReferredQuoteQuantums != 0 {
		i = encodeVarintAffiliates(dAtA, i, uint64(m.Maximum_30DCommissionPerReferredQuoteQuantums))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AffiliateParameters) Size() (n int) {
	...
	_ = l
	if m.Maximum_30DCommissionPerReferredQuoteQuantums != 0 {
		n += 1 + sovAffiliates(uint64(m.Maximum_30DCommissionPerReferredQuoteQuantums))
	}
	if m.RefereeMinimumFeeTierIdx != 0 {
		n += 1 + sovAffiliates(uint64(m.RefereeMinimumFeeTierIdx))
	}
	if m.Maximum_30DAttributableRevenuePerAffiliateQuoteQuantums != 0 {
		n += 1 + sovAffiliates(uint64(m.Maximum_30DAttributableRevenuePerAffiliateQuoteQuantums))
	}
	return n
}
...
func (m *AffiliateParameters) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Maximum_30DCommissionPerReferredQuoteQuantums", wireType)
			}
			m.Maximum_30DCommissionPerReferredQuoteQuantums = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAffiliates
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Maximum_30DCommissionPerReferredQuoteQuantums |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Maximum_30DAttributableRevenuePerAffiliateQuoteQuantums", wireType)
			}
			m.Maximum_30DAttributableRevenuePerAffiliateQuoteQuantums = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAffiliates
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Maximum_30DAttributableRevenuePerAffiliateQuoteQuantums |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
