...
var fileDescriptor_460d8062a262197e = []byte{
	...
	0x17, 0x33, 0x17, 0xb3, 0x6f, 0x71, 0xba, 0xd0, 0x64, 0x46, 0x2e, 0x69, 0x7c, 0xa9, 0x1f, 0x67,
	...
	0xc4, 0xc8, 0x25, 0x17, 0x9c, 0x5a, 0x82, 0x2f, 0x11, 0x59, 0xe3, 0xb6, 0x8d, 0x60, 0xfc, 0x49,
	0x39, 0x53, 0xa0, 0x19, 0xe6, 0x48, 0xa7, 0x90, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63,
	0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc2, 0x63, 0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96,
	0x63, 0x88, 0xb2, 0x4a, 0xcf, 0x2c, 0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x47, 0x29,
	0x40, 0xcb, 0x4c, 0x74, 0x93, 0x33, 0x12, 0x33, 0xf3, 0xf4, 0xe1, 0x22, 0x15, 0x48, 0x25, 0x7f,
	0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0x58, 0xca, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xc1, 0xb9,
	0x6b, 0x18, 0x1f, 0x06, 0x00, 0x00,
}
...
type MsgClient interface {
	...
	SetUnconditionalRevShareConfig(ctx context.Context, in *MsgUpdateUnconditionalRevShareConfig, opts ...grpc.CallOption) (*MsgUpdateUnconditionalRevShareConfigResponse, error)
}
...
func (c *msgClient) SetUnconditionalRevShareConfig(ctx context.Context, in *MsgUpdateUnconditionalRevShareConfig, opts ...grpc.CallOption) (*MsgUpdateUnconditionalRevShareConfigResponse, error) {
	out := new(MsgUpdateUnconditionalRevShareConfigResponse)
	err := c.cc.Invoke(ctx, "/dydxprotocol.revshare.Msg/SetUnconditionalRevShareConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	SetUnconditionalRevShareConfig(context.Context, *MsgUpdateUnconditionalRevShareConfig) (*MsgUpdateUnconditionalRevShareConfigResponse, error)
}
...
func (*UnimplementedMsgServer) SetUnconditionalRevShareConfig(ctx context.Context, req *MsgUpdateUnconditionalRevShareConfig) (*MsgUpdateUnconditionalRevShareConfigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetUnconditionalRevShareConfig not implemented")
}
...
func _Msg_SetUnconditionalRevShareConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgUpdateUnconditionalRevShareConfig)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).SetUnconditionalRevShareConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dydxprotocol.revshare.Msg/SetUnconditionalRevShareConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).SetUnconditionalRevShareConfig(ctx, req.(*MsgUpdateUnconditionalRevShareConfig))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetUnconditionalRevShareConfig",
			Handler:    _Msg_SetUnconditionalRevShareConfig_Handler,
		},
	},
