...
type UserStats struct {
	...
	// Taker fee generated in usd
	TakerFeeGenerated uint64 `protobuf:"varint,3,opt,name=taker_fee_generated,json=takerFeeGenerated,proto3" json:"taker_fee_generated,omitempty"`
	// Maker fee generated in usd
	MakerFeeGenerated uint64 `protobuf:"varint,4,opt,name=maker_fee_generated,json=makerFeeGenerated,proto3" json:"maker_fee_generated,omitempty"`
	// Affilliate revenue generated
	ReferredRevenue uint64 `protobuf:"varint,5,opt,name=referred_revenue,json=referredRevenue,proto3" json:"referred_revenue,omitempty"`
}
...
func (m *UserStats) GetTakerFeeGenerated() uint64 {
	if m != nil {
		return m.TakerFeeGenerated
	}
	return 0
}

func (m *UserStats) GetMakerFeeGenerated() uint64 {
	if m != nil {
		return m.MakerFeeGenerated
	}
	return 0
}

func (m *UserStats) GetReferredRevenue() uint64 {
	if m != nil {
		return m.ReferredRevenue
	}
	return 0
}
...
var fileDescriptor_07475747e6dcccdc = []byte{
	...
	,
}
...
func (m *UserStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ReferredRevenue != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.ReferredRevenue))
		i--
		dAtA[i] = 0x28
	}
	if m.MakerFeeGenerated != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.MakerFeeGenerated))
		i--
		dAtA[i] = 0x20
	}
	if m.TakerFeeGenerated != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.TakerFeeGenerated))
		i--
		dAtA[i] = 0x18
	}
...
func (m *UserStats) Size() (n int) {
	...
	if m.TakerFeeGenerated != 0 {
		n += 1 + sovStats(uint64(m.TakerFeeGenerated))
	}
	if m.MakerFeeGenerated != 0 {
		n += 1 + sovStats(uint64(m.MakerFeeGenerated))
	}
	if m.ReferredRevenue != 0 {
		n += 1 + sovStats(uint64(m.ReferredRevenue))
	}
	return n
}
...
func (m *UserStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TakerFeeGenerated", wireType)
			}
			m.TakerFeeGenerated = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TakerFeeGenerated |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MakerFeeGenerated", wireType)
			}
			m.MakerFeeGenerated = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MakerFeeGenerated |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReferredRevenue", wireType)
			}
			m.ReferredRevenue = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReferredRevenue |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
