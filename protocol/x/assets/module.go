...
// RegisterRESTRoutes registers the assets module's REST service handlers.
...
// BeginBlock executes all ABCI BeginBlock logic respective to the assets module.
func (am AppModule) BeginBlock(_ sdk.Context, _ abci.RequestBeginBlock) {}

// EndBlock executes all ABCI EndBlock logic respective to the assets module. It
