...
func TestSetNewYieldIndex(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			initialAssetYieldIndex:  keeper.ConvertStringToBigRatWithPanicOnErr("0"),
			expectedAssetYieldIndex: keeper.ConvertStringToBigRatWithPanicOnErr("0"),
			expectErr:               true,
