...
const (
	// CROSS is a market type where the margin is shared across all positions
	// in the market.
	PerpetualMarketType_CROSS PerpetualMarketType = 0
	// ISOLATED is a market type where the margin is isolated to the individual
	// market
	PerpetualMarketType_ISOLATED PerpetualMarketType = 1
)
...
func (m *PerpetualParams) GetMarketType() PerpetualMarketType {
	...
	return PerpetualMarketType_CROSS
}
...
var fileDescriptor_ce7204eee10038be = []byte{
	...
	,
}
