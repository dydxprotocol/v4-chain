...
type GenesisState struct {
	...
	// All locked shares.
	AllLockedShares []LockedShares `protobuf:"bytes,5,rep,name=all_locked_shares,json=allLockedShares,proto3" json:"all_locked_shares"`
}
...
func (m *GenesisState) GetAllLockedShares() []LockedShares {
	if m != nil {
		return m.AllLockedShares
	}
	return nil
}
...
var fileDescriptor_4be4a747b209e41c = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AllLockedShares) > 0 {
		for iNdEx := len(m.AllLockedShares) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AllLockedShares[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	n += 1 + l + sovGenesis(uint64(l))
	if len(m.AllLockedShares) > 0 {
		for _, e := range m.AllLockedShares {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllLockedShares", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllLockedShares = append(m.AllLockedShares, LockedShares{})
			if err := m.AllLockedShares[len(m.AllLockedShares)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
