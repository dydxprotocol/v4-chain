...
var (
	filter_Query_OwnerShares_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	...
	pattern_Query_TotalShares_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dydxprotocol", "vault", "total_shares"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OwnerShares_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dydxprotocol", "vault", "owner_shares"}, "", runtime.AssumeColonVerbOpt(false)))
)
