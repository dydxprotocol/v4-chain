...
func CmdPlaceStatefulOrder() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "place-stateful-order owner subaccount_number clientId clobPairId side quantums subticks goodTilBlockTime",
		Short: "Broadcast message place_stateful_order.",
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			msg := types.NewMsgPlaceOrder(
				types.Order{
					...
					GoodTilOneof: &types.Order_GoodTilBlockTime{GoodTilBlockTime: argGoodTilBlockTime},
				},
			)
