...
func TestPlaceOrder_ReduceOnlyMy(t *testing.T) {
	...
	tests := map[string]struct {
		...
		`Can place a reduce-only IOC taker order that matches with a regular maker order, taker order
			change their subaccount's position side and need to be resized.`: {
			placedMatchableOrders: []types.MatchableOrder{
			...
			order: constants.Order_Alice_Num1_Id2_Clob0_Buy20_Price30_GTB20_RO_IOC,
			...
			expectedPendingMatches: []expectedMatch{
				{
					...
					takerOrder:      &constants.Order_Alice_Num1_Id2_Clob0_Buy20_Price30_GTB20_RO_IOC,
					matchedQuantums: 20,
				},
			},
			expectedExistingMatches: []expectedMatch{},
			...
			expectedSubaccountOpenReduceOnlyOrders: map[types.ClobPairId]map[satypes.SubaccountId]map[types.OrderId]bool{
				...
				// 		constants.Order_Alice_Num1_Id2_Clob0_Buy20_Price30_GTB20_RO_IOC.OrderId: true,
				// 	},
				// },
			},
			expectedCancelledReduceOnlyOrders: []types.OrderId{
				// constants.Order_Alice_Num1_Id2_Clob0_Buy20_Price30_GTB20_RO_IOC.OrderId,
			},
		},
	}
