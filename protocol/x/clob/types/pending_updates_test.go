	...
	tests := []struct {
		...
		},
		{
			...
			expectedUpdates: []satypes.Update{
				...
				{
					SubaccountId: constants.Alice_Num1,
					AssetUpdates: testutil.CreateUsdcAssetUpdates(big.NewInt(200)),
					PerpetualUpdates: []satypes.PerpetualUpdate{
						{
							PerpetualId:      uint32(1),
			...
			expectedUpdates: []satypes.Update{
				{
					SubaccountId: constants.Bob_Num0,
					// - 10_050 - (fee) 6
					AssetUpdates: testutil.CreateUsdcAssetUpdates(big.NewInt(-10_056)),
					PerpetualUpdates: []satypes.PerpetualUpdate{
						{
							PerpetualId:      uint32(0),
							BigQuantumsDelta: big.NewInt(100),
				...
				},
				{
					SubaccountId: constants.Alice_Num0,
					// - 10_000 - (fee) 5
					AssetUpdates: testutil.CreateUsdcAssetUpdates(big.NewInt(-10005)),
					PerpetualUpdates: []satypes.PerpetualUpdate{
						{
							PerpetualId:      uint32(0),
							BigQuantumsDelta: big.NewInt(100),
				...
				},
				{
					SubaccountId: constants.Alice_Num1,
					// 20_000 - (fee) 4
					AssetUpdates: testutil.CreateUsdcAssetUpdates(big.NewInt(19_996)),
					PerpetualUpdates: []satypes.PerpetualUpdate{
						{
							PerpetualId:      uint32(1),
							BigQuantumsDelta: big.NewInt(-200),
		...
		},
		{
			...
			expectedUpdates: []satypes.Update{
				{
					SubaccountId: constants.Alice_Num0,
					AssetUpdates: testutil.CreateUsdcAssetUpdates(big.NewInt(-250)),
					PerpetualUpdates: []satypes.PerpetualUpdate{
						{
							PerpetualId:      uint32(0),
			...
			expectedUpdates: []satypes.Update{
				{
					...
					AssetUpdates: testutil.CreateUsdcAssetUpdates(big.NewInt(-12_807)),
					PerpetualUpdates: []satypes.PerpetualUpdate{
						{
							PerpetualId:      uint32(0),
							BigQuantumsDelta: big.NewInt(50),
			...
			expectedUpdates: []satypes.Update{
				{
					...
					AssetUpdates: testutil.CreateUsdcAssetUpdates(big.NewInt(-12_800)),
					PerpetualUpdates: []satypes.PerpetualUpdate{
						{
							PerpetualId:      uint32(0),
							BigQuantumsDelta: big.NewInt(50),
