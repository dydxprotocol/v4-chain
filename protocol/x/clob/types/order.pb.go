...
// StatefulOrderCancellation represents the cancellation of a stateful order in
// state. It stores the order id and the `GoodTilBlockTime` of the cancellation.
type StatefulOrderCancellation struct {
	...
	// stateful order cancellation will be considered expired and removed from
	// state.
	GoodTilBlockTime uint32 `protobuf:"fixed32,2,opt,name=good_til_block_time,json=goodTilBlockTime,proto3" json:"good_til_block_time,omitempty"`
}

func (m *StatefulOrderCancellation) Reset()         { *m = StatefulOrderCancellation{} }
func (m *StatefulOrderCancellation) String() string { return proto.CompactTextString(m) }
func (*StatefulOrderCancellation) ProtoMessage()    {}
func (*StatefulOrderCancellation) Descriptor() ([]byte, []int) {
	return fileDescriptor_673c6f4faa93736b, []int{6}
}
func (m *StatefulOrderCancellation) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StatefulOrderCancellation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StatefulOrderCancellation.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StatefulOrderCancellation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatefulOrderCancellation.Merge(m, src)
}
func (m *StatefulOrderCancellation) XXX_Size() int {
	return m.Size()
}
func (m *StatefulOrderCancellation) XXX_DiscardUnknown() {
	xxx_messageInfo_StatefulOrderCancellation.DiscardUnknown(m)
}

var xxx_messageInfo_StatefulOrderCancellation proto.InternalMessageInfo

func (m *StatefulOrderCancellation) GetOrderId() OrderId {
	if m != nil {
		return m.OrderId
	}
	return OrderId{}
...
func (m *StatefulOrderCancellation) GetGoodTilBlockTime() uint32 {
	if m != nil {
		return m.GoodTilBlockTime
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*StatefulOrderCancellation)(nil), "dydxprotocol.clob.StatefulOrderCancellation")
...
var fileDescriptor_673c6f4faa93736b = []byte{
	...
	,
}
...
func (m *StatefulOrderCancellation) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StatefulOrderCancellation) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StatefulOrderCancellation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.GoodTilBlockTime != 0 {
		i -= 4
...
func (m *StatefulOrderCancellation) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StatefulOrderCancellation) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StatefulOrderCancellation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StatefulOrderCancellation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.GoodTilBlockTime = 0
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			}
			m.GoodTilBlockTime = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
		default:
			iNdEx = preIndex
			skippy, err := skipOrder(dAtA[iNdEx:])
