...
type StreamUpdate_SubaccountUpdate struct {
	SubaccountUpdate *StreamSubaccountUpdate `protobuf:"bytes,4,opt,name=subaccount_update,json=subaccountUpdate,proto3,oneof" json:"subaccount_update,omitempty"`
}
...
func (m *StreamSubaccountUpdate) GetSubaccountId() *types.SubaccountId {
	if m != nil {
...
type QueryPerpetualClobDetails struct {
	ClobPair  ClobPair         `protobuf:"bytes,1,opt,name=clob_pair,json=clobPair,proto3" json:"clob_pair"`
	Perpetual types2.Perpetual `protobuf:"bytes,2,opt,name=perpetual,proto3" json:"perpetual"`
}

func (m *QueryPerpetualClobDetails) Reset()         { *m = QueryPerpetualClobDetails{} }
func (m *QueryPerpetualClobDetails) String() string { return proto.CompactTextString(m) }
func (*QueryPerpetualClobDetails) ProtoMessage()    {}
func (*QueryPerpetualClobDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_3365c195b25c5bc0, []int{24}
}
func (m *QueryPerpetualClobDetails) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryPerpetualClobDetails) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryPerpetualClobDetails.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryPerpetualClobDetails) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryPerpetualClobDetails.Merge(m, src)
}
func (m *QueryPerpetualClobDetails) XXX_Size() int {
	return m.Size()
}
func (m *QueryPerpetualClobDetails) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryPerpetualClobDetails.DiscardUnknown(m)
}

var xxx_messageInfo_QueryPerpetualClobDetails proto.InternalMessageInfo

func (m *QueryPerpetualClobDetails) GetClobPair() ClobPair {
	if m != nil {
		return m.ClobPair
	}
	return ClobPair{}
...
func (m *QueryPerpetualClobDetails) GetPerpetual() types2.Perpetual {
	if m != nil {
		return m.Perpetual
	}
	return types2.Perpetual{}
}

// QueryGetPerpetualClobDetailsRequest is request type to get the perpetual clob details.
type QueryGetPerpetualClobDetailsRequest struct {
	Id uint32 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
}

func (m *QueryGetPerpetualClobDetailsRequest) Reset()         { *m = QueryGetPerpetualClobDetailsRequest{} }
func (m *QueryGetPerpetualClobDetailsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGetPerpetualClobDetailsRequest) ProtoMessage()    {}
func (*QueryGetPerpetualClobDetailsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3365c195b25c5bc0, []int{25}
}
func (m *QueryGetPerpetualClobDetailsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetPerpetualClobDetailsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetPerpetualClobDetailsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetPerpetualClobDetailsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetPerpetualClobDetailsRequest.Merge(m, src)
}
func (m *QueryGetPerpetualClobDetailsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetPerpetualClobDetailsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetPerpetualClobDetailsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetPerpetualClobDetailsRequest proto.InternalMessageInfo

func (m *QueryGetPerpetualClobDetailsRequest) GetId() uint32 {
	if m != nil {
		return m.Id
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*QueryPerpetualClobDetails)(nil), "dydxprotocol.clob.QueryPerpetualClobDetails")
	proto.RegisterType((*QueryGetPerpetualClobDetailsRequest)(nil), "dydxprotocol.clob.QueryGetPerpetualClobDetailsRequest")
}
...
var fileDescriptor_3365c195b25c5bc0 = []byte{
	...
	,
}
...
func (m *StreamOrderbookFill) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FillAmounts) > 0 {
		dAtA19 := make([]byte, len(m.FillAmounts)*10)
		var j18 int
...
func (m *QueryPerpetualClobDetails) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryPerpetualClobDetails) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryPerpetualClobDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGetPerpetualClobDetailsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetPerpetualClobDetailsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetPerpetualClobDetailsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryPerpetualClobDetails) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetPerpetualClobDetailsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryPerpetualClobDetails) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryPerpetualClobDetails: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryPerpetualClobDetails: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryGetPerpetualClobDetailsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetPerpetualClobDetailsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetPerpetualClobDetailsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
