...
type StreamUpdate_TakerOrderStatus struct {
	TakerOrderStatus *StreamTakerOrderStatus `protobuf:"bytes,3,opt,name=taker_order_status,json=takerOrderStatus,proto3,oneof" json:"taker_order_status,omitempty"`
}

func (*StreamUpdate_OrderbookUpdate) isStreamUpdate_UpdateMessage()  {}
func (*StreamUpdate_OrderFill) isStreamUpdate_UpdateMessage()        {}
func (*StreamUpdate_TakerOrderStatus) isStreamUpdate_UpdateMessage() {}
...
func (m *StreamUpdate) GetTakerOrderStatus() *StreamTakerOrderStatus {
	if x, ok := m.GetUpdateMessage().(*StreamUpdate_TakerOrderStatus); ok {
		return x.TakerOrderStatus
	}
	return nil
}
...
func (*StreamUpdate) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*StreamUpdate_TakerOrderStatus)(nil),
	}
}
...
var fileDescriptor_3365c195b25c5bc0 = []byte{
	...
	,
}
...
func (m *StreamUpdate_TakerOrderStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StreamUpdate_TakerOrderStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *StreamOrderbookFill) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FillAmounts) > 0 {
		dAtA17 := make([]byte, len(m.FillAmounts)*10)
		var j16 int
...
func (m *StreamUpdate_TakerOrderStatus) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StreamUpdate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			v := &StreamTakerOrderStatus{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.UpdateMessage = &StreamUpdate_TakerOrderStatus{v}
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
