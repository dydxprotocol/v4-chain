...
type QueryOrderFillStatesRequest struct {
}

func (m *QueryOrderFillStatesRequest) Reset()         { *m = QueryOrderFillStatesRequest{} }
func (m *QueryOrderFillStatesRequest) String() string { return proto.CompactTextString(m) }
func (*QueryOrderFillStatesRequest) ProtoMessage()    {}
func (*QueryOrderFillStatesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3365c195b25c5bc0, []int{12}
}
func (m *QueryOrderFillStatesRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryOrderFillStatesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryOrderFillStatesRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryOrderFillStatesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryOrderFillStatesRequest.Merge(m, src)
}
func (m *QueryOrderFillStatesRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryOrderFillStatesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryOrderFillStatesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryOrderFillStatesRequest proto.InternalMessageInfo

type QueryOrderFillStatesResponse struct {
	OrderIdAndFillState []*OrderIdAndFillState `protobuf:"bytes,1,rep,name=OrderIdAndFillState,proto3" json:"OrderIdAndFillState,omitempty"`
}

func (m *QueryOrderFillStatesResponse) Reset()         { *m = QueryOrderFillStatesResponse{} }
func (m *QueryOrderFillStatesResponse) String() string { return proto.CompactTextString(m) }
func (*QueryOrderFillStatesResponse) ProtoMessage()    {}
func (*QueryOrderFillStatesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3365c195b25c5bc0, []int{13}
}
func (m *QueryOrderFillStatesResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryOrderFillStatesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryOrderFillStatesResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryOrderFillStatesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryOrderFillStatesResponse.Merge(m, src)
}
func (m *QueryOrderFillStatesResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryOrderFillStatesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryOrderFillStatesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryOrderFillStatesResponse proto.InternalMessageInfo

func (m *QueryOrderFillStatesResponse) GetOrderIdAndFillState() []*OrderIdAndFillState {
	if m != nil {
		return m.OrderIdAndFillState
	}
	return nil
}

type QueryPrunableOrdersRequest struct {
	BlockHeight uint32 `protobuf:"varint,1,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
}

func (m *QueryPrunableOrdersRequest) Reset()         { *m = QueryPrunableOrdersRequest{} }
func (m *QueryPrunableOrdersRequest) String() string { return proto.CompactTextString(m) }
func (*QueryPrunableOrdersRequest) ProtoMessage()    {}
func (*QueryPrunableOrdersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3365c195b25c5bc0, []int{14}
}
func (m *QueryPrunableOrdersRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryPrunableOrdersRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryPrunableOrdersRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryPrunableOrdersRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryPrunableOrdersRequest.Merge(m, src)
}
func (m *QueryPrunableOrdersRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryPrunableOrdersRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryPrunableOrdersRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryPrunableOrdersRequest proto.InternalMessageInfo

func (m *QueryPrunableOrdersRequest) GetBlockHeight() uint32 {
	if m != nil {
...
type QueryPrunableOrdersResponse struct {
	PrunableOrders []*OrderId `protobuf:"bytes,1,rep,name=prunable_orders,json=prunableOrders,proto3" json:"prunable_orders,omitempty"`
}

func (m *QueryPrunableOrdersResponse) Reset()         { *m = QueryPrunableOrdersResponse{} }
func (m *QueryPrunableOrdersResponse) String() string { return proto.CompactTextString(m) }
func (*QueryPrunableOrdersResponse) ProtoMessage()    {}
func (*QueryPrunableOrdersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3365c195b25c5bc0, []int{15}
}
func (m *QueryPrunableOrdersResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryPrunableOrdersResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryPrunableOrdersResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryPrunableOrdersResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryPrunableOrdersResponse.Merge(m, src)
}
func (m *QueryPrunableOrdersResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryPrunableOrdersResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryPrunableOrdersResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryPrunableOrdersResponse proto.InternalMessageInfo

func (m *QueryPrunableOrdersResponse) GetPrunableOrders() []*OrderId {
	if m != nil {
		return m.PrunableOrders
	}
	return nil
}

type OrderIdAndFillState struct {
	OrderId   *OrderId        `protobuf:"bytes,1,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`
	FillState *OrderFillState `protobuf:"bytes,2,opt,name=fill_state,json=fillState,proto3" json:"fill_state,omitempty"`
}

func (m *OrderIdAndFillState) Reset()         { *m = OrderIdAndFillState{} }
func (m *OrderIdAndFillState) String() string { return proto.CompactTextString(m) }
func (*OrderIdAndFillState) ProtoMessage()    {}
func (*OrderIdAndFillState) Descriptor() ([]byte, []int) {
	return fileDescriptor_3365c195b25c5bc0, []int{16}
}
func (m *OrderIdAndFillState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OrderIdAndFillState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OrderIdAndFillState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OrderIdAndFillState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OrderIdAndFillState.Merge(m, src)
}
func (m *OrderIdAndFillState) XXX_Size() int {
	return m.Size()
}
func (m *OrderIdAndFillState) XXX_DiscardUnknown() {
	xxx_messageInfo_OrderIdAndFillState.DiscardUnknown(m)
}

var xxx_messageInfo_OrderIdAndFillState proto.InternalMessageInfo

func (m *OrderIdAndFillState) GetOrderId() *OrderId {
	if m != nil {
		return m.OrderId
	}
	return nil
...
func (m *OrderIdAndFillState) GetFillState() *OrderFillState {
	if m != nil {
		return m.FillState
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryOrderFillStatesRequest)(nil), "dydxprotocol.clob.QueryOrderFillStatesRequest")
	proto.RegisterType((*QueryOrderFillStatesResponse)(nil), "dydxprotocol.clob.QueryOrderFillStatesResponse")
	proto.RegisterType((*QueryPrunableOrdersRequest)(nil), "dydxprotocol.clob.QueryPrunableOrdersRequest")
	proto.RegisterType((*QueryPrunableOrdersResponse)(nil), "dydxprotocol.clob.QueryPrunableOrdersResponse")
	proto.RegisterType((*OrderIdAndFillState)(nil), "dydxprotocol.clob.OrderIdAndFillState")
...
var fileDescriptor_3365c195b25c5bc0 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	OrderFillStates(ctx context.Context, in *QueryOrderFillStatesRequest, opts ...grpc.CallOption) (*QueryOrderFillStatesResponse, error)
	PrunableOrders(ctx context.Context, in *QueryPrunableOrdersRequest, opts ...grpc.CallOption) (*QueryPrunableOrdersResponse, error)
...
func (c *queryClient) OrderFillStates(ctx context.Context, in *QueryOrderFillStatesRequest, opts ...grpc.CallOption) (*QueryOrderFillStatesResponse, error) {
	out := new(QueryOrderFillStatesResponse)
	err := c.cc.Invoke(ctx, "/dydxprotocol.clob.Query/OrderFillStates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PrunableOrders(ctx context.Context, in *QueryPrunableOrdersRequest, opts ...grpc.CallOption) (*QueryPrunableOrdersResponse, error) {
	out := new(QueryPrunableOrdersResponse)
	err := c.cc.Invoke(ctx, "/dydxprotocol.clob.Query/PrunableOrders", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	OrderFillStates(context.Context, *QueryOrderFillStatesRequest) (*QueryOrderFillStatesResponse, error)
	PrunableOrders(context.Context, *QueryPrunableOrdersRequest) (*QueryPrunableOrdersResponse, error)
	// Streams orderbook updates.
...
func (*UnimplementedQueryServer) OrderFillStates(ctx context.Context, req *QueryOrderFillStatesRequest) (*QueryOrderFillStatesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrderFillStates not implemented")
}
func (*UnimplementedQueryServer) PrunableOrders(ctx context.Context, req *QueryPrunableOrdersRequest) (*QueryPrunableOrdersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PrunableOrders not implemented")
}
...
func _Query_OrderFillStates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryOrderFillStatesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).OrderFillStates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dydxprotocol.clob.Query/OrderFillStates",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).OrderFillStates(ctx, req.(*QueryOrderFillStatesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_PrunableOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryPrunableOrdersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).PrunableOrders(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dydxprotocol.clob.Query/PrunableOrders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).PrunableOrders(ctx, req.(*QueryPrunableOrdersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "OrderFillStates",
			Handler:    _Query_OrderFillStates_Handler,
		},
		{
			MethodName: "PrunableOrders",
			Handler:    _Query_PrunableOrders_Handler,
		},
	},
...
func (m *QueryOrderFillStatesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryOrderFillStatesRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryOrderFillStatesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryOrderFillStatesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryOrderFillStatesResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryOrderFillStatesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.OrderIdAndFillState) > 0 {
		for iNdEx := len(m.OrderIdAndFillState) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OrderIdAndFillState[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryPrunableOrdersRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryPrunableOrdersRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryPrunableOrdersRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryPrunableOrdersResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryPrunableOrdersResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryPrunableOrdersResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.PrunableOrders) > 0 {
		for iNdEx := len(m.PrunableOrders) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PrunableOrders[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *OrderIdAndFillState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OrderIdAndFillState) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OrderIdAndFillState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.FillState != nil {
		{
			size, err := m.FillState.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *QueryOrderFillStatesRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryOrderFillStatesResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.OrderIdAndFillState) > 0 {
		for _, e := range m.OrderIdAndFillState {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryPrunableOrdersRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryPrunableOrdersResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.PrunableOrders) > 0 {
		for _, e := range m.PrunableOrders {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *OrderIdAndFillState) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryOrderFillStatesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryOrderFillStatesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryOrderFillStatesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryOrderFillStatesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryOrderFillStatesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryOrderFillStatesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrderIdAndFillState", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OrderIdAndFillState = append(m.OrderIdAndFillState, &OrderIdAndFillState{})
			if err := m.OrderIdAndFillState[len(m.OrderIdAndFillState)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QueryPrunableOrdersRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryPrunableOrdersRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryPrunableOrdersRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryPrunableOrdersResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryPrunableOrdersResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryPrunableOrdersResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrunableOrders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrunableOrders = append(m.PrunableOrders, &OrderId{})
			if err := m.PrunableOrders[len(m.PrunableOrders)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *OrderIdAndFillState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OrderIdAndFillState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OrderIdAndFillState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FillState", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FillState == nil {
				m.FillState = &OrderFillState{}
			}
			if err := m.FillState.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
