...
type MsgSetClobPairStatus struct {
	...
	ClobPairStatus ClobPair_Status `protobuf:"varint,3,opt,name=clob_pair_status,json=clobPairStatus,proto3,enum=dydxprotocol.clob.ClobPair_Status" json:"clob_pair_status,omitempty"`
}
...
func (m *MsgSetClobPairStatus) GetClobPairStatus() ClobPair_Status {
	if m != nil {
...
var fileDescriptor_19b9e2c0de4ab64a = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ClobPairStatus |= ClobPair_Status(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
