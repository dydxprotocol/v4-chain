...
type MsgBatchCancel struct {
	...
	ShortTermOrders []OrderBatch `protobuf:"bytes,2,rep,name=short_term_orders,json=shortTermOrders,proto3" json:"short_term_orders"`
...
func (m *MsgBatchCancel) GetShortTermOrders() []OrderBatch {
	if m != nil {
		return m.ShortTermOrders
	}
	return nil
}
...
type OrderBatch struct {
	// Clob Pair ID all orders in this order batch belong to.
	ClobPairId uint32 `protobuf:"varint,1,opt,name=clob_pair_id,json=clobPairId,proto3" json:"clob_pair_id,omitempty"`
	// List of Clob Pair IDs in this order batch.
	ClientId []uint32 `protobuf:"fixed32,2,rep,packed,name=client_id,json=clientId,proto3" json:"client_id,omitempty"`
}
...
func (m *OrderBatch) GetClientId() []uint32 {
	if m != nil {
		return m.ClientId
	}
	return nil
...
var fileDescriptor_19b9e2c0de4ab64a = []byte{
	...
	,
}
...
func (m *MsgBatchCancel) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ShortTermOrders) > 0 {
		for iNdEx := len(m.ShortTermOrders) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ShortTermOrders[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *OrderBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.ClientId) > 0 {
		for iNdEx := len(m.ClientId) - 1; iNdEx >= 0; iNdEx-- {
			i -= 4
			encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(m.ClientId[iNdEx]))
		}
		i = encodeVarintTx(dAtA, i, uint64(len(m.ClientId)*4))
		i--
		dAtA[i] = 0x12
	}
	if m.ClobPairId != 0 {
...
func (m *MsgBatchCancel) Size() (n int) {
	...
	n += 1 + l + sovTx(uint64(l))
	if len(m.ShortTermOrders) > 0 {
		for _, e := range m.ShortTermOrders {
			l = e.Size()
			n += 1 + l + sovTx(uint64(l))
		}
	}
...
func (m *OrderBatch) Size() (n int) {
	...
	if len(m.ClientId) > 0 {
		n += 1 + sovTx(uint64(len(m.ClientId)*4)) + len(m.ClientId)*4
	}
	return n
}
...
func (m *MsgBatchCancel) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShortTermOrders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ShortTermOrders = append(m.ShortTermOrders, OrderBatch{})
			if err := m.ShortTermOrders[len(m.ShortTermOrders)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 5 {
				...
				v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
				iNdEx += 4
				m.ClientId = append(m.ClientId, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.ClientId) == 0 {
					m.ClientId = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					if (iNdEx + 4) > l {
