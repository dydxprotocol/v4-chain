...
const (
	...
	ClobPairStatus_UNSPECIFIED ClobPairStatus = 0
	// ACTIVE represents an active clob pair.
	ClobPairStatus_ACTIVE ClobPairStatus = 1
	// PAUSED behavior is unfinalized.
	// TODO(DEC-600): update this documentation.
	ClobPairStatus_PAUSED ClobPairStatus = 2
	// CANCEL_ONLY behavior is unfinalized.
	// TODO(DEC-600): update this documentation.
	ClobPairStatus_CANCEL_ONLY ClobPairStatus = 3
	// POST_ONLY behavior is unfinalized.
	// TODO(DEC-600): update this documentation.
	ClobPairStatus_POST_ONLY ClobPairStatus = 4
	// INITIALIZING represents a newly-added clob pair.
	// Clob pairs in this state only accept orders which are
	// both short-term and post-only.
	ClobPairStatus_INITIALIZING ClobPairStatus = 5
)
...
type ClobPair struct {
	...
	// Status of the CLOB.
	Status ClobPairStatus `protobuf:"varint,8,opt,name=status,proto3,enum=dydxprotocol.clob.ClobPairStatus" json:"status,omitempty"`
}
...
func (m *ClobPair) GetStatus() ClobPairStatus {
	if m != nil {
		return m.Status
	}
...
func init() {
	proto.RegisterEnum("dydxprotocol.clob.ClobPairStatus", ClobPairStatus_name, ClobPairStatus_value)
...
var fileDescriptor_178b475635886947 = []byte{
	...
	,
}
