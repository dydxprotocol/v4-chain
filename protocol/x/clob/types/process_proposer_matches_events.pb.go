...
type ProcessProposerMatchesEvents struct {
	...
	PlacedStatefulCancellations             []OrderId `protobuf:"bytes,4,rep,name=placed_stateful_cancellations,json=placedStatefulCancellations,proto3" json:"placed_stateful_cancellations"`
...
func (m *ProcessProposerMatchesEvents) GetPlacedStatefulCancellations() []OrderId {
	if m != nil {
		return m.PlacedStatefulCancellations
	}
	return nil
}
...
var fileDescriptor_4626e94e6961a770 = []byte{
	...
	,
}
...
func (m *ProcessProposerMatchesEvents) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PlacedStatefulCancellations) > 0 {
		for iNdEx := len(m.PlacedStatefulCancellations) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PlacedStatefulCancellations[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ProcessProposerMatchesEvents) Size() (n int) {
	...
	if len(m.PlacedStatefulCancellations) > 0 {
		for _, e := range m.PlacedStatefulCancellations {
			l = e.Size()
			n += 1 + l + sovProcessProposerMatchesEvents(uint64(l))
		}
	}
...
func (m *ProcessProposerMatchesEvents) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PlacedStatefulCancellations", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PlacedStatefulCancellations = append(m.PlacedStatefulCancellations, OrderId{})
			if err := m.PlacedStatefulCancellations[len(m.PlacedStatefulCancellations)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
