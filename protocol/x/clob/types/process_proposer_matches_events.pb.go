...
type ProcessProposerMatchesEvents struct {
	...
	RemovedStatefulOrders                   []OrderRemoval `protobuf:"bytes,5,rep,name=removed_stateful_orders,json=removedStatefulOrders,proto3" json:"removed_stateful_orders"`
...
func (m *ProcessProposerMatchesEvents) GetRemovedStatefulOrders() []OrderRemoval {
	if m != nil {
		return m.RemovedStatefulOrders
	}
	return nil
}
...
var fileDescriptor_4626e94e6961a770 = []byte{
	...
	,
}
...
func (m *ProcessProposerMatchesEvents) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RemovedStatefulOrders) > 0 {
		for iNdEx := len(m.RemovedStatefulOrders) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RemovedStatefulOrders[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ProcessProposerMatchesEvents) Size() (n int) {
	...
	if len(m.RemovedStatefulOrders) > 0 {
		for _, e := range m.RemovedStatefulOrders {
			l = e.Size()
			n += 1 + l + sovProcessProposerMatchesEvents(uint64(l))
		}
	}
...
func (m *ProcessProposerMatchesEvents) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RemovedStatefulOrders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RemovedStatefulOrders = append(m.RemovedStatefulOrders, OrderRemoval{})
			if err := m.RemovedStatefulOrders[len(m.RemovedStatefulOrders)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
