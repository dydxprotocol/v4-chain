...
func (k msgServer) UpdateEquityTierLimitConfiguration(goCtx context.Context, configuration *types.MsgUpdateEquityTierLimitConfiguration) (*types.MsgUpdateEquityTierLimitConfigurationResponse, error) {
