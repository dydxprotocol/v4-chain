...
func TestProcessRewardsForBlock(t *testing.T) {
	...
	tokenPrice2TDai := pricestypes.MarketPrice{
		Id:        testRewardTokenMarketId,
		SpotPrice: 200_000_000, // 2$ per full coin.
		PnlPrice:  200_000_000, // 2$ per full coin.
		Exponent:  -8,
	}

	tokenPrice1_18TDai := pricestypes.MarketPrice{
		Id:        testRewardTokenMarketId,
		SpotPrice: 118_000_000, // 1.18$ per full coin.
		PnlPrice:  118_000_000, // 1.18$ per full coin.
		Exponent:  -8,
	}
