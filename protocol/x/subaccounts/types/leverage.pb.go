...
func (m *PerpetualLeverageEntry) GetImfPpm() uint32 {
	if m != nil {
		return m.ImfPpm
	}
	return 0
...
// LeverageData represents the leverage settings for a subaccount (internal storage)
type LeverageData struct {
	// List of leverage entries for this subaccount (stored by perpetual_id)
...
var fileDescriptor_78a5174593f1c911 = []byte{
	...
	,
}
...
func (m *PerpetualLeverageEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ImfPpm != 0 {
		i = encodeVarintLeverage(dAtA, i, uint64(m.ImfPpm))
		i--
		dAtA[i] = 0x10
	}
	if m.PerpetualId != 0 {
...
func (m *PerpetualLeverageEntry) Size() (n int) {
	...
	if m.ImfPpm != 0 {
		n += 1 + sovLeverage(uint64(m.ImfPpm))
	}
	return n
}
