...
type PerpetualPosition struct {
	...
	// The last settled funding payment amount (in quote quantums).
	// Note: a positive value means funding payment was paid out and
	// a negative value means funding payment was received.
	LastFundingPayment github_com_dydxprotocol_v4_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=last_funding_payment,json=lastFundingPayment,proto3,customtype=github.com/dydxprotocol/v4/dtypes.SerializableInt" json:"last_funding_payment"`
}
...
var fileDescriptor_e659838f8a8f5498 = []byte{
	...
	,
}
...
func (m *PerpetualPosition) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.LastFundingPayment.Size()
		i -= size
		if _, err := m.LastFundingPayment.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *PerpetualPosition) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastFundingPayment", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LastFundingPayment.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
