...
import (
	...
	daemonconstants "github.com/dydxprotocol/v4/daemons/constants"
...
func GenerateDefaultExchangeTomlString() bytes.Buffer {
	...
	err = template.Execute(&defaultExchangeToml, constants.StaticExchangeStartupConfig)
	if err != nil {
		panic(err)
	}
...
func ReadExchangeStartupConfigFile(homeDir string) map[types.ExchangeId]*types.ExchangeStartupConfig {
	...
	exchanges := map[string][]types.ExchangeStartupConfig{}
