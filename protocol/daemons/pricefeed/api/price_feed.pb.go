...
// source: klyraprotocol/daemons/pricefeed/price_feed.proto
...
func (*UpdateMarketPricesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ebe1fed40bce46a, []int{0}
}
...
func (*UpdateMarketPricesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ebe1fed40bce46a, []int{1}
}
...
func (*ExchangePrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ebe1fed40bce46a, []int{2}
}
...
func (*MarketPriceUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ebe1fed40bce46a, []int{3}
}
...
func init() {
	proto.RegisterType((*UpdateMarketPricesRequest)(nil), "klyraprotocol.daemons.pricefeed.UpdateMarketPricesRequest")
	proto.RegisterType((*UpdateMarketPricesResponse)(nil), "klyraprotocol.daemons.pricefeed.UpdateMarketPricesResponse")
	proto.RegisterType((*ExchangePrice)(nil), "klyraprotocol.daemons.pricefeed.ExchangePrice")
	proto.RegisterType((*MarketPriceUpdate)(nil), "klyraprotocol.daemons.pricefeed.MarketPriceUpdate")
}

func init() {
	proto.RegisterFile("klyraprotocol/daemons/pricefeed/price_feed.proto", fileDescriptor_2ebe1fed40bce46a)
}

var fileDescriptor_2ebe1fed40bce46a = []byte{
	// 445 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *priceFeedServiceClient) UpdateMarketPrices(ctx context.Context, in *UpdateMarketPricesRequest, opts ...grpc.CallOption) (*UpdateMarketPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/klyraprotocol.daemons.pricefeed.PriceFeedService/UpdateMarketPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PriceFeedService_UpdateMarketPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/klyraprotocol.daemons.pricefeed.PriceFeedService/UpdateMarketPrices",
	}
...
var _PriceFeedService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "klyraprotocol.daemons.pricefeed.PriceFeedService",
	...
	Metadata: "klyraprotocol/daemons/pricefeed/price_feed.proto",
}
