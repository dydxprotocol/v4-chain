...
require (
	...
	github.com/cockroachdb/pebble v0.0.0-20231119032537-b9be64b88e6a // indirect
...
replace (
	cosmossdk.io/client/v2 => github.com/dydxprotocol/cosmos-sdk/client/v2 v2.0.0-beta.1.0.20240214225014-c0bde14212a7
