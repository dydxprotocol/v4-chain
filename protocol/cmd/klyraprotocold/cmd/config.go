...
const (
	// `minGasPriceUtdai` is default minimum gas price in micro TDAI.
	minGasPriceUtdai = "0.025" + assettypes.TDaiDenom
	// `minGasPriceStakeToken` is the default minimum gas price in stake token.
	// TODO(GENESIS): `adv4tnt` is a placeholder for the stake token of the klyra chain.
	...
	// is roughly the same in value as 0.025 micro TDAI.
...
func initAppConfig() (string, *KlyraAppConfig) {
...
func initTendermintConfig() *tmcfg.Config {
	...
	// (https://github.com/StreamFinance-Protocol/tendermint/blob/dc03b21cf5d54c641e1d14b14fae5920fa7ba656/config/config.go#L982)
