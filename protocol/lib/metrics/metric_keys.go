...
const (
	...
	GrpcOrderbookSubscriptionChannelLength  = "grpc_orderbook_subscription_channel_length"
	GrpcSubaccountSubscriptionChannelLength = "grpc_subaccount_subscription_channel_length"
