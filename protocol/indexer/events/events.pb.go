...
type PerpetualMarketCreateEventV1_Status int32

const (
	// Default value. This value is invalid and unused.
	PerpetualMarketCreateEventV1_STATUS_UNSPECIFIED PerpetualMarketCreateEventV1_Status = 0
	// STATUS_ACTIVE behavior is unfinalized.
	// TODO(DEC-600): update this documentation.
	PerpetualMarketCreateEventV1_STATUS_ACTIVE PerpetualMarketCreateEventV1_Status = 1
	// STATUS_PAUSED behavior is unfinalized.
	// TODO(DEC-600): update this documentation.
	PerpetualMarketCreateEventV1_STATUS_PAUSED PerpetualMarketCreateEventV1_Status = 2
	// STATUS_CANCEL_ONLY behavior is unfinalized.
	// TODO(DEC-600): update this documentation.
	PerpetualMarketCreateEventV1_STATUS_CANCEL_ONLY PerpetualMarketCreateEventV1_Status = 3
	// STATUS_POST_ONLY behavior is unfinalized.
	// TODO(DEC-600): update this documentation.
	PerpetualMarketCreateEventV1_STATUS_POST_ONLY PerpetualMarketCreateEventV1_Status = 4
)

var PerpetualMarketCreateEventV1_Status_name = map[int32]string{
...
var PerpetualMarketCreateEventV1_Status_value = map[string]int32{
...
func (x PerpetualMarketCreateEventV1_Status) String() string {
	return proto.EnumName(PerpetualMarketCreateEventV1_Status_name, int32(x))
}

func (PerpetualMarketCreateEventV1_Status) EnumDescriptor() ([]byte, []int) {
...
type PerpetualMarketCreateEventV1 struct {
	...
	// Defined in perpetuals.perpetual
	MarketId uint32                              `protobuf:"varint,4,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
	Status   PerpetualMarketCreateEventV1_Status `protobuf:"varint,5,opt,name=status,proto3,enum=dydxprotocol.indexer.events.PerpetualMarketCreateEventV1_Status" json:"status,omitempty"`
...
func (m *PerpetualMarketCreateEventV1) GetStatus() PerpetualMarketCreateEventV1_Status {
	if m != nil {
		return m.Status
	}
	return PerpetualMarketCreateEventV1_STATUS_UNSPECIFIED
}
...
func init() {
	...
	proto.RegisterEnum("dydxprotocol.indexer.events.PerpetualMarketCreateEventV1_Status", PerpetualMarketCreateEventV1_Status_name, PerpetualMarketCreateEventV1_Status_value)
...
var fileDescriptor_6331dfb59c6fd2bb = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= PerpetualMarketCreateEventV1_Status(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
