...
type OrderFillEventV1 struct {
	...
	MakerOrderRouterFee uint64 `protobuf:"varint,16,opt,name=maker_order_router_fee,json=makerOrderRouterFee,proto3" json:"maker_order_router_fee,omitempty"`
	// fee for taker order router in USDC quantums.
	TakerOrderRouterFee uint64 `protobuf:"varint,17,opt,name=taker_order_router_fee,json=takerOrderRouterFee,proto3" json:"taker_order_router_fee,omitempty"`
}
