...
type StatefulOrderEventV1_OrderReplace struct {
	OrderReplace *StatefulOrderEventV1_StatefulOrderReplacementV1 `protobuf:"bytes,8,opt,name=order_replace,json=orderReplace,proto3,oneof" json:"order_replace,omitempty"`
}
...
func (m *StatefulOrderEventV1) GetOrderReplace() *StatefulOrderEventV1_StatefulOrderReplacementV1 {
...
// A stateful order placement contains an order.
type StatefulOrderEventV1_StatefulOrderReplacementV1 struct {
	Order *types.IndexerOrder `protobuf:"bytes,1,opt,name=order,proto3" json:"order,omitempty"`
}

func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) Reset() {
	*m = StatefulOrderEventV1_StatefulOrderReplacementV1{}
}
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) String() string {
	return proto.CompactTextString(m)
}
func (*StatefulOrderEventV1_StatefulOrderReplacementV1) ProtoMessage() {}
func (*StatefulOrderEventV1_StatefulOrderReplacementV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_6331dfb59c6fd2bb, []int{13, 5}
}
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StatefulOrderEventV1_StatefulOrderReplacementV1.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatefulOrderEventV1_StatefulOrderReplacementV1.Merge(m, src)
}
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) XXX_Size() int {
	return m.Size()
}
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) XXX_DiscardUnknown() {
	xxx_messageInfo_StatefulOrderEventV1_StatefulOrderReplacementV1.DiscardUnknown(m)
}

var xxx_messageInfo_StatefulOrderEventV1_StatefulOrderReplacementV1 proto.InternalMessageInfo

func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) GetOrder() *types.IndexerOrder {
	if m != nil {
		return m.Order
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*StatefulOrderEventV1_StatefulOrderReplacementV1)(nil), "dydxprotocol.indexer.events.StatefulOrderEventV1.StatefulOrderReplacementV1")
...
var fileDescriptor_6331dfb59c6fd2bb = []byte{
	...
	,
}
...
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StatefulOrderEventV1) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			v := &StatefulOrderEventV1_StatefulOrderReplacementV1{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *StatefulOrderEventV1_StatefulOrderReplacementV1) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StatefulOrderReplacementV1: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StatefulOrderReplacementV1: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
