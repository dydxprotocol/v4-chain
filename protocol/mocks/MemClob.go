...
// PrintOrderbookSnapshot provides a mock function with given fields: ctx
func (_m *MemClob) PrintOrderbookSnapshot(ctx types.Context) string {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for PrintOrderbookSnapshot")
	}
