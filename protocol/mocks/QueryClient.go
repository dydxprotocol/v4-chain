...
// BlockLimitsConfiguration provides a mock function with given fields: ctx, in, opts
func (_m *QueryClient) BlockLimitsConfiguration(ctx context.Context, in *clobtypes.QueryBlockLimitsConfigurationRequest, opts ...grpc.CallOption) (*clobtypes.QueryBlockLimitsConfigurationResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for BlockLimitsConfiguration")
	}

	var r0 *clobtypes.QueryBlockLimitsConfigurationResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *clobtypes.QueryBlockLimitsConfigurationRequest, ...grpc.CallOption) (*clobtypes.QueryBlockLimitsConfigurationResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *clobtypes.QueryBlockLimitsConfigurationRequest, ...grpc.CallOption) *clobtypes.QueryBlockLimitsConfigurationResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*clobtypes.QueryBlockLimitsConfigurationResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *clobtypes.QueryBlockLimitsConfigurationRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
