...
// AllStatefulOrders provides a mock function with given fields: ctx, in, opts
func (_m *QueryClient) AllStatefulOrders(ctx context.Context, in *clobtypes.QueryAllStatefulOrdersRequest, opts ...grpc.CallOption) (*clobtypes.QueryAllStatefulOrdersResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *clobtypes.QueryAllStatefulOrdersResponse
	if rf, ok := ret.Get(0).(func(context.Context, *clobtypes.QueryAllStatefulOrdersRequest, ...grpc.CallOption) *clobtypes.QueryAllStatefulOrdersResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*clobtypes.QueryAllStatefulOrdersResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *clobtypes.QueryAllStatefulOrdersRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// StatefulOrderCount provides a mock function with given fields: ctx, in, opts
func (_m *QueryClient) StatefulOrderCount(ctx context.Context, in *clobtypes.QueryStatefulOrderCountRequest, opts ...grpc.CallOption) (*clobtypes.QueryStatefulOrderCountResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *clobtypes.QueryStatefulOrderCountResponse
	if rf, ok := ret.Get(0).(func(context.Context, *clobtypes.QueryStatefulOrderCountRequest, ...grpc.CallOption) *clobtypes.QueryStatefulOrderCountResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*clobtypes.QueryStatefulOrderCountResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *clobtypes.QueryStatefulOrderCountRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
