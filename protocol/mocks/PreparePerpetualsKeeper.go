...
// GetAddPremiumVotes provides a mock function with given fields: ctx, address
func (_m *PreparePerpetualsKeeper) GetAddPremiumVotes(ctx types.Context, address types.AccAddress) *perpetualstypes.MsgAddPremiumVotes {
	ret := _m.Called(ctx, address)

	var r0 *perpetualstypes.MsgAddPremiumVotes
	if rf, ok := ret.Get(0).(func(types.Context, types.AccAddress) *perpetualstypes.MsgAddPremiumVotes); ok {
		r0 = rf(ctx, address)
	} else {
		if ret.Get(0) != nil {
