...
// CreatePerpetualClobPair provides a mock function with given fields: ctx, perpetualId, stepSizeInBaseQuantums, quantumConversionExponent, subticksPerTick, status, makerFeePpm, takerFeePpm
func (_m *ClobKeeper) CreatePerpetualClobPair(ctx types.Context, perpetualId uint32, stepSizeInBaseQuantums subaccountstypes.BaseQuantums, quantumConversionExponent int32, subticksPerTick uint32, status clobtypes.ClobPair_Status, makerFeePpm uint32, takerFeePpm uint32) (clobtypes.ClobPair, error) {
	ret := _m.Called(ctx, perpetualId, stepSizeInBaseQuantums, quantumConversionExponent, subticksPerTick, status, makerFeePpm, takerFeePpm)

	var r0 clobtypes.ClobPair
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, uint32, subaccountstypes.BaseQuantums, int32, uint32, clobtypes.ClobPair_Status, uint32, uint32) (clobtypes.ClobPair, error)); ok {
		return rf(ctx, perpetualId, stepSizeInBaseQuantums, quantumConversionExponent, subticksPerTick, status, makerFeePpm, takerFeePpm)
	}
	if rf, ok := ret.Get(0).(func(types.Context, uint32, subaccountstypes.BaseQuantums, int32, uint32, clobtypes.ClobPair_Status, uint32, uint32) clobtypes.ClobPair); ok {
		r0 = rf(ctx, perpetualId, stepSizeInBaseQuantums, quantumConversionExponent, subticksPerTick, status, makerFeePpm, takerFeePpm)
	} else {
		r0 = ret.Get(0).(clobtypes.ClobPair)
	}

	if rf, ok := ret.Get(1).(func(types.Context, uint32, subaccountstypes.BaseQuantums, int32, uint32, clobtypes.ClobPair_Status, uint32, uint32) error); ok {
		r1 = rf(ctx, perpetualId, stepSizeInBaseQuantums, quantumConversionExponent, subticksPerTick, status, makerFeePpm, takerFeePpm)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ClobKeeper) GetPerpetualPositionToLiquidate(ctx types.Context, subaccountId subaccountstypes.SubaccountId) (clobtypes.ClobPair, *big.Int, error) {
	...
	var r1 *big.Int
	var r2 error
	if rf, ok := ret.Get(0).(func(types.Context, subaccountstypes.SubaccountId) (clobtypes.ClobPair, *big.Int, error)); ok {
