...
func (_m *PricesKeeper) CreateMarket(ctx context.Context, param pricestypes.MarketParam, price pricestypes.MarketPrice) (pricestypes.MarketParam, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, pricestypes.MarketParam, pricestypes.MarketPrice) (pricestypes.MarketParam, error)); ok {
		return rf(ctx, param, price)
	}
	if rf, ok := ret.Get(0).(func(context.Context, pricestypes.MarketParam, pricestypes.MarketPrice) pricestypes.MarketParam); ok {
		r0 = rf(ctx, param, price)
	} else {
		r0 = ret.Get(0).(pricestypes.MarketParam)
	}

	if rf, ok := ret.Get(1).(func(context.Context, pricestypes.MarketParam, pricestypes.MarketPrice) error); ok {
...
func (_m *PricesKeeper) GetCurrencyPairFromID(ctx context.Context, id uint64) (pkgtypes.CurrencyPair, bool) {
	...
	var r1 bool
	if rf, ok := ret.Get(0).(func(context.Context, uint64) (pkgtypes.CurrencyPair, bool)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64) pkgtypes.CurrencyPair); ok {
		r0 = rf(ctx, id)
	} else {
...
func (_m *PricesKeeper) GetIDForCurrencyPair(ctx context.Context, cp pkgtypes.CurrencyPair) (uint64, bool) {
	...
	var r0 uint64
	var r1 bool
	if rf, ok := ret.Get(0).(func(context.Context, pkgtypes.CurrencyPair) (uint64, bool)); ok {
		return rf(ctx, cp)
	}
	if rf, ok := ret.Get(0).(func(context.Context, pkgtypes.CurrencyPair) uint64); ok {
		r0 = rf(ctx, cp)
	} else {
		r0 = ret.Get(0).(uint64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, pkgtypes.CurrencyPair) bool); ok {
		r1 = rf(ctx, cp)
	} else {
		r1 = ret.Get(1).(bool)
	}
...
func (_m *PricesKeeper) GetPriceForCurrencyPair(ctx context.Context, cp pkgtypes.CurrencyPair) (oracletypes.QuotePrice, error) {
	ret := _m.Called(ctx, cp)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, pkgtypes.CurrencyPair) (oracletypes.QuotePrice, error)); ok {
		return rf(ctx, cp)
	}
	if rf, ok := ret.Get(0).(func(context.Context, pkgtypes.CurrencyPair) oracletypes.QuotePrice); ok {
		r0 = rf(ctx, cp)
	} else {
		r0 = ret.Get(0).(oracletypes.QuotePrice)
	}

	if rf, ok := ret.Get(1).(func(context.Context, pkgtypes.CurrencyPair) error); ok {
		r1 = rf(ctx, cp)
	} else {
		r1 = ret.Error(1)
	}
