...
func (_m *PricesKeeper) GetCurrencyPairFromID(ctx types.Context, id uint64) (oracletypes.CurrencyPair, bool) {
...
func (_m *PricesKeeper) GetIDForCurrencyPair(ctx types.Context, cp oracletypes.CurrencyPair) (uint64, bool) {
...
func (_m *PricesKeeper) GetPriceForCurrencyPair(ctx types.Context, cp oracletypes.CurrencyPair) (oracletypes.QuotePrice, error) {
	ret := _m.Called(ctx, cp)
