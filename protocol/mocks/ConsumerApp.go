...
// ConsumerApp is an autogenerated mock type for the ConsumerApp type
type ConsumerApp struct {
	mock.Mock
}

// AppCodec provides a mock function with given fields:
func (_m *ConsumerApp) AppCodec() codec.Codec {
	ret := _m.Called()
...
func (_m *ConsumerApp) ApplySnapshotChunk(_a0 *types.RequestApplySnapshotChunk) (*types.ResponseApplySnapshotChunk, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) CheckTx(_a0 *types.RequestCheckTx) (*types.ResponseCheckTx, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) Commit() (*types.ResponseCommit, error) {
	ret := _m.Called()
...
func (_m *ConsumerApp) ExtendVote(_a0 context.Context, _a1 *types.RequestExtendVote) (*types.ResponseExtendVote, error) {
...
func (_m *ConsumerApp) FinalizeBlock(_a0 *types.RequestFinalizeBlock) (*types.ResponseFinalizeBlock, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) GetBaseApp() *baseapp.BaseApp {
	ret := _m.Called()
...
func (_m *ConsumerApp) GetConsumerKeeper() keeper.Keeper {
	ret := _m.Called()
...
func (_m *ConsumerApp) GetIBCKeeper() *corekeeper.Keeper {
	ret := _m.Called()
...
func (_m *ConsumerApp) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	ret := _m.Called()
...
func (_m *ConsumerApp) GetStakingKeeper() testingtypes.StakingKeeper {
	ret := _m.Called()
...
func (_m *ConsumerApp) GetSubspace(moduleName string) paramstypes.Subspace {
...
func (_m *ConsumerApp) GetTestAccountKeeper() integration.TestAccountKeeper {
	ret := _m.Called()
...
func (_m *ConsumerApp) GetTestBankKeeper() integration.TestBankKeeper {
	ret := _m.Called()
...
func (_m *ConsumerApp) GetTestEvidenceKeeper() evidencekeeper.Keeper {
	ret := _m.Called()
...
func (_m *ConsumerApp) GetTestSlashingKeeper() integration.TestSlashingKeeper {
	ret := _m.Called()
...
func (_m *ConsumerApp) GetTxConfig() client.TxConfig {
	ret := _m.Called()
...
func (_m *ConsumerApp) Info(_a0 *types.RequestInfo) (*types.ResponseInfo, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) InitChain(_a0 *types.RequestInitChain) (*types.ResponseInitChain, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) LastBlockHeight() int64 {
	ret := _m.Called()
...
func (_m *ConsumerApp) LastCommitID() storetypes.CommitID {
	ret := _m.Called()
...
func (_m *ConsumerApp) ListSnapshots(_a0 *types.RequestListSnapshots) (*types.ResponseListSnapshots, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) LoadSnapshotChunk(_a0 *types.RequestLoadSnapshotChunk) (*types.ResponseLoadSnapshotChunk, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) OfferSnapshot(_a0 *types.RequestOfferSnapshot) (*types.ResponseOfferSnapshot, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) PrepareProposal(_a0 *types.RequestPrepareProposal) (*types.ResponsePrepareProposal, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) ProcessProposal(_a0 *types.RequestProcessProposal) (*types.ResponseProcessProposal, error) {
	ret := _m.Called(_a0)
...
func (_m *ConsumerApp) Query(_a0 context.Context, _a1 *types.RequestQuery) (*types.ResponseQuery, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *ConsumerApp) VerifyVoteExtension(_a0 *types.RequestVerifyVoteExtension) (*types.ResponseVerifyVoteExtension, error) {
	ret := _m.Called(_a0)
...
// NewConsumerApp creates a new instance of ConsumerApp. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewConsumerApp(t interface {
	mock.TestingT
	Cleanup(func())
}) *ConsumerApp {
	mock := &ConsumerApp{}
