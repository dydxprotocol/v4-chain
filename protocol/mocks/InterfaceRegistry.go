...
// FindDescriptorByName provides a mock function with given fields: _a0
func (_m *InterfaceRegistry) FindDescriptorByName(_a0 protoreflect.FullName) (protoreflect.Descriptor, error) {
	ret := _m.Called(_a0)

	var r0 protoreflect.Descriptor
	var r1 error
	if rf, ok := ret.Get(0).(func(protoreflect.FullName) (protoreflect.Descriptor, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(protoreflect.FullName) protoreflect.Descriptor); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(protoreflect.FullName) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
// FindFileByPath provides a mock function with given fields: _a0
func (_m *InterfaceRegistry) FindFileByPath(_a0 string) (protoreflect.FileDescriptor, error) {
	ret := _m.Called(_a0)

	var r0 protoreflect.FileDescriptor
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (protoreflect.FileDescriptor, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(string) protoreflect.FileDescriptor); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
// RangeFiles provides a mock function with given fields: f
func (_m *InterfaceRegistry) RangeFiles(f func(protoreflect.FileDescriptor) bool) {
	_m.Called(f)
}
...
func (_m *InterfaceRegistry) Resolve(typeUrl string) (proto.Message, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (proto.Message, error)); ok {
		return rf(typeUrl)
	}
...
func (_m *InterfaceRegistry) SigningContext() *signing.Context {
	ret := _m.Called()

	var r0 *signing.Context
	if rf, ok := ret.Get(0).(func() *signing.Context); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*signing.Context)
		}
	}
...
// mustEmbedInterfaceRegistry provides a mock function with given fields:
func (_m *InterfaceRegistry) mustEmbedInterfaceRegistry() {
	_m.Called()
}
