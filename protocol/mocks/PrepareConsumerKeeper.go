...
type mockConstructorTestingTNewPrepareConsumerKeeper interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewPrepareConsumerKeeper(t mockConstructorTestingTNewPrepareConsumerKeeper) *PrepareConsumerKeeper {
