...
// AddPreexistingStatefulOrder provides a mock function with given fields: ctx, order, blockHeight, memclob
func (_m *MemClobKeeper) AddPreexistingStatefulOrder(ctx types.Context, order *clobtypes.Order, blockHeight uint32, memclob clobtypes.MemClob) (subaccountstypes.BaseQuantums, clobtypes.OrderStatus, *clobtypes.OffchainUpdates, error) {
	ret := _m.Called(ctx, order, blockHeight, memclob)

	var r0 subaccountstypes.BaseQuantums
	if rf, ok := ret.Get(0).(func(types.Context, *clobtypes.Order, uint32, clobtypes.MemClob) subaccountstypes.BaseQuantums); ok {
		r0 = rf(ctx, order, blockHeight, memclob)
	} else {
		r0 = ret.Get(0).(subaccountstypes.BaseQuantums)
	}

	var r1 clobtypes.OrderStatus
	if rf, ok := ret.Get(1).(func(types.Context, *clobtypes.Order, uint32, clobtypes.MemClob) clobtypes.OrderStatus); ok {
		r1 = rf(ctx, order, blockHeight, memclob)
	} else {
		r1 = ret.Get(1).(clobtypes.OrderStatus)
	}

	var r2 *clobtypes.OffchainUpdates
	if rf, ok := ret.Get(2).(func(types.Context, *clobtypes.Order, uint32, clobtypes.MemClob) *clobtypes.OffchainUpdates); ok {
		r2 = rf(ctx, order, blockHeight, memclob)
	} else {
		if ret.Get(2) != nil {
	...
	var r3 error
	if rf, ok := ret.Get(3).(func(types.Context, *clobtypes.Order, uint32, clobtypes.MemClob) error); ok {
		r3 = rf(ctx, order, blockHeight, memclob)
	} else {
		r3 = ret.Error(3)
	}
