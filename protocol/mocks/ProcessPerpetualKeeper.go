...
func (_m *ProcessPerpetualKeeper) GetSettlementPpm(ctx types.Context, perpetualId uint32, quantums *int256.Int, index *int256.Int) (*int256.Int, *int256.Int, error) {
	...
	var r1 *int256.Int
	var r2 error
	if rf, ok := ret.Get(0).(func(types.Context, uint32, *int256.Int, *int256.Int) (*int256.Int, *int256.Int, error)); ok {
		return rf(ctx, perpetualId, quantums, index)
	}
	if rf, ok := ret.Get(0).(func(types.Context, uint32, *int256.Int, *int256.Int) *int256.Int); ok {
	...
	if rf, ok := ret.Get(1).(func(types.Context, uint32, *int256.Int, *int256.Int) *int256.Int); ok {
	...
	if rf, ok := ret.Get(2).(func(types.Context, uint32, *int256.Int, *int256.Int) error); ok {
