...
########################################################################## 
### Required proposal fields. TODO: update below fields as needed      ###
########################################################################## 
TITLE="TODO: Fill in proposal title" 
NATIVE_TOKEN_DENOM="adv4tnt" # This is testnet token 
PROPOSAL_BODY="""
...
# Amount of tokens to transfer from bridge to vesters. Note: value has 18 decimals
...
########################################################################## 
AUTHORITY="dydx10d07y265gmmuvt4z0w9aw880jnsr700jnmapky" # Governance module account
...
rewards_update_1_block = estimate_block_height(
    BLOCK_HEIGHT_FOR_ESTIMATE, 
    BLOCK_TIME_FOR_ESTIMATE,
    ...
    proposal_template["messages"].append(
        {
            ...
            "msg": {
                ...
                "params": {
                    ...
                    "denomExponent": -18,
                    "marketId": 1000001,
                    "fee_multiplier_ppm": fee_multiplier
                }
            },
            "delay_blocks": delay
        }
