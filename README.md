...
<br>## Welcome to Perpetual Trading<br>dYdX V4's Cosmos-based chain powers DeFi perps—new contributors, start with the Indexer tutorial for your first trade API. Tip: Use gRPC for queries! <br>
