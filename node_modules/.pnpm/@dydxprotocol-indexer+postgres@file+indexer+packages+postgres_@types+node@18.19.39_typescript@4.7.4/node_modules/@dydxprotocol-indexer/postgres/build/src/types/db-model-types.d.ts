...
export declare type SubaccountAssetNetTransferMap = {
    [subaccountId: string]: {
        [assetId: string]: string;
    };
};
export declare type SubaccountToPerpetualPositionsMap = {
    [subaccountId: string]: {
        [perpetualId: string]: PerpetualPositionFromDatabase;
    };
};
export declare type PerpetualPositionsMap = {
    [perpetualMarketId: string]: PerpetualPositionFromDatabase;
};
export declare type PerpetualMarketsMap = {
    [perpetualMarketId: string]: PerpetualMarketFromDatabase;
};
export declare type AssetsMap = {
    [assetId: string]: AssetFromDatabase;
};
export declare type LiquidityTiersMap = {
    [liquidityTierId: number]: LiquidityTiersFromDatabase;
};
export declare type SubaccountUsdcMap = {
    [subaccountId: string]: Big;
};
export declare type AssetPositionsMap = {
    [subaccountId: string]: AssetPositionFromDatabase[];
};
export declare type MarketsMap = {
    [marketId: number]: MarketFromDatabase;
};
export declare type OraclePricesMap = {
    [marketId: number]: OraclePriceFromDatabase[];
};
export declare type PriceMap = {
    [marketId: number]: string;
};
export declare type FundingIndexMap = {
    [perpetualId: string]: Big;
};
export declare type CandlesResolutionMap = {
    [resolution: string]: CandleFromDatabase;
};
export declare type CandlesMap = {
    [ticker: string]: CandlesResolutionMap;
};
export {};
