...
export const createStargateClient = ({
  ...
  t.variableDeclaration('const', [t.variableDeclarator(t.objectPattern([t.objectProperty(t.identifier('registry'), t.identifier('registry'), false, true), t.objectProperty(t.identifier('aminoTypes'), t.identifier('aminoTypes'), false, true)]), t.callExpression(t.identifier(options), optsFuncArgs))]), // client
