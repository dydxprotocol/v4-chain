...
export declare enum OrderRemovalReason {
...
export declare const OrderRemovalReasonSDKType: typeof OrderRemovalReason;
export declare function orderRemovalReasonFromJSON(object: any): OrderRemovalReason;
export declare function orderRemovalReasonToJSON(object: OrderRemovalReason): string;
