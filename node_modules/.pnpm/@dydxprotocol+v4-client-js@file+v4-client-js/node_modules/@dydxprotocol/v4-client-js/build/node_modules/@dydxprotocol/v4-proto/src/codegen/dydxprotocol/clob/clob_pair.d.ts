...
export declare const PerpetualClobMetadata: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): PerpetualClobMetadata;
    fromPartial(object: {
...
export declare const SpotClobMetadata: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): SpotClobMetadata;
    fromPartial(object: {
...
export declare const ClobPair: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): ClobPair;
    fromPartial(object: {
        id?: number | undefined;
        perpetualClobMetadata?: {
            perpetualId?: number | undefined;
        ...
        status?: ClobPair_Status | undefined;
    }): ClobPair;
};
