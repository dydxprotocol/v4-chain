...
export declare const Coin: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): Coin;
    fromPartial(object: {
...
export declare const DecCoin: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): DecCoin;
    fromPartial(object: {
        denom?: string | undefined;
        amount?: string | undefined;
    }): DecCoin;
...
export declare const IntProto: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): IntProto;
    fromPartial(object: {
...
export declare const DecProto: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): DecProto;
    fromPartial(object: {
