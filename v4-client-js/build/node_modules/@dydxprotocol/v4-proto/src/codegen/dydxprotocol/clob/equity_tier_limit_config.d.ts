...
export declare const EquityTierLimitConfiguration: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): EquityTierLimitConfiguration;
    fromPartial(object: {
...
export declare const EquityTierLimit: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): EquityTierLimit;
    fromPartial(object: {
        usdTncRequired?: Uint8Array | undefined;
        limit?: number | undefined;
    }): EquityTierLimit;
