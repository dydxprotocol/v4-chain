...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    cosmos: {
        app: {
            v1alpha1: {
                config(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/app/v1alpha1/query").QueryConfigRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/app/v1alpha1/query").QueryConfigResponse>;
            };
        };
        auth: {
            v1beta1: {
                accounts(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/auth/v1beta1/query").QueryAccountsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/auth/v1beta1/query").QueryAccountsResponse>;
                ...
                params(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/auth/v1beta1/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/auth/v1beta1/query").QueryParamsResponse>;
                moduleAccounts(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/auth/v1beta1/query").QueryModuleAccountsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/auth/v1beta1/query").QueryModuleAccountsResponse>;
                ...
                bech32Prefix(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/auth/v1beta1/query").Bech32PrefixRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/auth/v1beta1/query").Bech32PrefixResponse>;
        ...
        bank: {
            v1beta1: {
                ...
                totalSupply(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/bank/v1beta1/query").QueryTotalSupplyRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/bank/v1beta1/query").QueryTotalSupplyResponse>;
                ...
                params(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/bank/v1beta1/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/bank/v1beta1/query").QueryParamsResponse>;
                ...
                denomsMetadata(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/bank/v1beta1/query").QueryDenomsMetadataRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/bank/v1beta1/query").QueryDenomsMetadataResponse>;
        ...
        base: {
            node: {
                v1beta1: {
                    config(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/node/v1beta1/query").ConfigRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/node/v1beta1/query").ConfigResponse>;
                    status(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/node/v1beta1/query").StatusRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/node/v1beta1/query").StatusResponse>;
                };
            };
            tendermint: {
                v1beta1: {
                    getNodeInfo(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/tendermint/v1beta1/query").GetNodeInfoRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/tendermint/v1beta1/query").GetNodeInfoResponse>;
                    getSyncing(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/tendermint/v1beta1/query").GetSyncingRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/tendermint/v1beta1/query").GetSyncingResponse>;
                    getLatestBlock(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/tendermint/v1beta1/query").GetLatestBlockRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/tendermint/v1beta1/query").GetLatestBlockResponse>;
                    ...
                    getLatestValidatorSet(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/tendermint/v1beta1/query").GetLatestValidatorSetRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/base/tendermint/v1beta1/query").GetLatestValidatorSetResponse>;
        ...
        circuit: {
            v1: {
                ...
                accounts(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/circuit/v1/query").QueryAccountsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/circuit/v1/query").AccountsResponse>;
                disabledList(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/circuit/v1/query").QueryDisabledListRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/circuit/v1/query").DisabledListResponse>;
            };
        };
        consensus: {
            v1: {
                params(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/consensus/v1/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/consensus/v1/query").QueryParamsResponse>;
            };
        };
        distribution: {
            v1beta1: {
                params(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/distribution/v1beta1/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/distribution/v1beta1/query").QueryParamsResponse>;
                ...
                communityPool(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/distribution/v1beta1/query").QueryCommunityPoolRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/distribution/v1beta1/query").QueryCommunityPoolResponse>;
            };
        };
        evidence: {
            v1beta1: {
                ...
                allEvidence(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/evidence/v1beta1/query").QueryAllEvidenceRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/evidence/v1beta1/query").QueryAllEvidenceResponse>;
            };
        };
        feegrant: {
            v1beta1: {
        ...
        gov: {
            v1: {
                constitution(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/gov/v1/query").QueryConstitutionRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/gov/v1/query").QueryConstitutionResponse>;
        ...
        group: {
            v1: {
                ...
                groups(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/group/v1/query").QueryGroupsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/group/v1/query").QueryGroupsResponse>;
            };
        };
        mint: {
            v1beta1: {
                params(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/mint/v1beta1/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/mint/v1beta1/query").QueryParamsResponse>;
                inflation(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/mint/v1beta1/query").QueryInflationRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/mint/v1beta1/query").QueryInflationResponse>;
                annualProvisions(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/mint/v1beta1/query").QueryAnnualProvisionsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/mint/v1beta1/query").QueryAnnualProvisionsResponse>;
            };
        };
        nft: {
            v1beta1: {
                ...
                classes(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/nft/v1beta1/query").QueryClassesRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/nft/v1beta1/query").QueryClassesResponse>;
            };
        };
        orm: {
            query: {
        ...
        params: {
            v1beta1: {
                ...
                subspaces(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/params/v1beta1/query").QuerySubspacesRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/params/v1beta1/query").QuerySubspacesResponse>;
            };
        };
        slashing: {
            v1beta1: {
                params(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/slashing/v1beta1/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/slashing/v1beta1/query").QueryParamsResponse>;
                ...
                signingInfos(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/slashing/v1beta1/query").QuerySigningInfosRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/slashing/v1beta1/query").QuerySigningInfosResponse>;
            };
        };
        staking: {
            v1beta1: {
                ...
                pool(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/staking/v1beta1/query").QueryPoolRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/staking/v1beta1/query").QueryPoolResponse>;
                params(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/staking/v1beta1/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/staking/v1beta1/query").QueryParamsResponse>;
            };
        };
        tx: {
            v1beta1: {
        ...
        upgrade: {
            v1beta1: {
                currentPlan(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/upgrade/v1beta1/query").QueryCurrentPlanRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/upgrade/v1beta1/query").QueryCurrentPlanResponse>;
                ...
                authority(request?: import("@dydxprotocol/v4-proto/src/codegen/cosmos/upgrade/v1beta1/query").QueryAuthorityRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/cosmos/upgrade/v1beta1/query").QueryAuthorityResponse>;
            };
        };
    };
    dydxprotocol: {
        assets: {
            ...
            allAssets(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/assets/query").QueryAllAssetsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/assets/query").QueryAllAssetsResponse>;
        };
        blocktime: {
            downtimeParams(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/blocktime/query").QueryDowntimeParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/blocktime/query").QueryDowntimeParamsResponse>;
            previousBlockInfo(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/blocktime/query").QueryPreviousBlockInfoRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/blocktime/query").QueryPreviousBlockInfoResponse>;
            allDowntimeInfo(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/blocktime/query").QueryAllDowntimeInfoRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/blocktime/query").QueryAllDowntimeInfoResponse>;
        };
        bridge: {
            eventParams(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QueryEventParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QueryEventParamsResponse>;
            proposeParams(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QueryProposeParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QueryProposeParamsResponse>;
            safetyParams(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QuerySafetyParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QuerySafetyParamsResponse>;
            acknowledgedEventInfo(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QueryAcknowledgedEventInfoRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QueryAcknowledgedEventInfoResponse>;
            recognizedEventInfo(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QueryRecognizedEventInfoRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/bridge/query").QueryRecognizedEventInfoResponse>;
        ...
        clob: {
            ...
            clobPairAll(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").QueryAllClobPairRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").QueryClobPairAllResponse>;
            areSubaccountsLiquidatable(request: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").AreSubaccountsLiquidatableRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").AreSubaccountsLiquidatableResponse>;
            ...
            equityTierLimitConfiguration(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").QueryEquityTierLimitConfigurationRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").QueryEquityTierLimitConfigurationResponse>;
            blockRateLimitConfiguration(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").QueryBlockRateLimitConfigurationRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").QueryBlockRateLimitConfigurationResponse>;
            liquidationsConfiguration(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").QueryLiquidationsConfigurationRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/clob/query").QueryLiquidationsConfigurationResponse>;
        };
        delaymsg: {
            nextDelayedMessageId(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/delaymsg/query").QueryNextDelayedMessageIdRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/delaymsg/query").QueryNextDelayedMessageIdResponse>;
        ...
        epochs: {
            ...
            epochInfoAll(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/epochs/query").QueryAllEpochInfoRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/epochs/query").QueryEpochInfoAllResponse>;
        };
        feetiers: {
            perpetualFeeParams(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/feetiers/query").QueryPerpetualFeeParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/feetiers/query").QueryPerpetualFeeParamsResponse>;
        ...
        perpetuals: {
            ...
            allPerpetuals(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryAllPerpetualsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryAllPerpetualsResponse>;
            allLiquidityTiers(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryAllLiquidityTiersRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryAllLiquidityTiersResponse>;
            premiumVotes(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryPremiumVotesRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryPremiumVotesResponse>;
            premiumSamples(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryPremiumSamplesRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryPremiumSamplesResponse>;
            params(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/perpetuals/query").QueryParamsResponse>;
        };
        prices: {
            ...
            allMarketPrices(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/prices/query").QueryAllMarketPricesRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/prices/query").QueryAllMarketPricesResponse>;
            ...
            allMarketParams(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/prices/query").QueryAllMarketParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/prices/query").QueryAllMarketParamsResponse>;
        };
        ratelimit: {
            listLimitParams(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/ratelimit/query").ListLimitParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/ratelimit/query").ListLimitParamsResponse>;
        ...
        rewards: {
            params(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/rewards/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/rewards/query").QueryParamsResponse>;
        };
        sending: {};
        stats: {
            params(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/stats/query").QueryParamsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/stats/query").QueryParamsResponse>;
            statsMetadata(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/stats/query").QueryStatsMetadataRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/stats/query").QueryStatsMetadataResponse>;
            globalStats(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/stats/query").QueryGlobalStatsRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/stats/query").QueryGlobalStatsResponse>;
        ...
        subaccounts: {
            ...
            subaccountAll(request?: import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/subaccounts/query").QueryAllSubaccountRequest): Promise<import("@dydxprotocol/v4-proto/src/codegen/dydxprotocol/subaccounts/query").QuerySubaccountAllResponse>;
        };
        vest: {
