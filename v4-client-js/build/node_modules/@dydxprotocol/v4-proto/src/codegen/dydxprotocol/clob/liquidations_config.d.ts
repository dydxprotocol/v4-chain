...
export declare const LiquidationsConfig: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): LiquidationsConfig;
    fromPartial(object: {
        maxLiquidationFeePpm?: number | undefined;
        positionBlockLimits?: {
            minPositionNotionalLiquidated?: string | number | Long.Long | undefined;
            maxPositionPortionLiquidatedPpm?: number | undefined;
        } | undefined;
        subaccountBlockLimits?: {
            maxNotionalLiquidated?: string | number | Long.Long | undefined;
            maxQuantumsInsuranceLost?: string | number | Long.Long | undefined;
        } | undefined;
        fillablePriceConfig?: {
...
export declare const PositionBlockLimits: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): PositionBlockLimits;
    fromPartial(object: {
        minPositionNotionalLiquidated?: string | number | Long.Long | undefined;
        maxPositionPortionLiquidatedPpm?: number | undefined;
    }): PositionBlockLimits;
...
export declare const SubaccountBlockLimits: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): SubaccountBlockLimits;
    fromPartial(object: {
        maxNotionalLiquidated?: string | number | Long.Long | undefined;
        maxQuantumsInsuranceLost?: string | number | Long.Long | undefined;
    }): SubaccountBlockLimits;
...
export declare const FillablePriceConfig: {
    ...
    decode(input: Uint8Array | _m0.Reader, length?: number | undefined): FillablePriceConfig;
    fromPartial(object: {
        bankruptcyAdjustmentPpm?: number | undefined;
        spreadToMaintenanceMarginRatioPpm?: number | undefined;
    }): FillablePriceConfig;
