...
export const getParsedObjectName = (ref, obj, scope) => {
  ...
  const allButPackage = _scope.splice(root.package.split('.').length); // pull off "this" name
...
export const parseType = (context, obj, scope, isNested = false) => {
...
export const parseEnum = (context, obj, scope, isNested = false) => {
  let name = obj.name; // parse nested names
...
export const parseService = (context, obj, scope, isNested = false) => {
  ...
  Object.entries(methodHash).forEach(([key, value]) => {
