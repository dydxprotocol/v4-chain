        ...
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            return (0, _prompt.prompt)([{
              ...
              choices: ['akash', // 'axelar',
              'bcna', // 'bitsong', // Error: namespace and package not supported, yet.
              // 'canto',
              // 'cht',
              'comdex', 'confio', 'cosmos', 'cosmos_proto', 'cosmwasm', // 'cronos',
              // 'cyber',
              // 'desmos',
              // 'echelon',
              // 'em',
              ...
              // 'evmos',
              // 'galaxy',
              'gogoproto', 'google', 'ibc', 'injective', 'juno', // 'kava',
              // 'likechain',
              // 'lumenx',
              'omniflix', // 'oracle',
              'osmosis', // 'panacea',
              'passage3d', 'persistence', // 'provenance',
              // 'pylons',
              'regen', // 'scavenge',
              // 'sentinel',
              // 'shentu',
              // 'sifnode',
              'stargaze', 'tendermint', 'umee' // 'uptake',
              // 'vidulum',
              ].map(function (name) {
                return {
                  name: name,
          ...
          case 11:
            ...
            (0, _mkdirp.sync)(tmp);
            process.chdir(tmp);
            (0, _shelljs.exec)("npm install ".concat(getPackages(pkg), " --production --prefix ./protobufs")); // protos
