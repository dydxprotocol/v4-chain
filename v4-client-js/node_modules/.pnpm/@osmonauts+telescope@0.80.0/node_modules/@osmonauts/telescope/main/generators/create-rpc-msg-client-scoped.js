...
var getFileName = function getFileName(dir, filename) {
  ...
  var localname = (0, _path.join)(dir, filename + '.tx');
  return localname + '.ts';
};

var makeRPC = function makeRPC(builder, bundler, rpc) {
  var _rpc$methodNameTx, _rpc$filename;

  var dir = rpc.dir;
  var packages = rpc.packages;
  var methodName = (_rpc$methodNameTx = rpc.methodNameTx) !== null && _rpc$methodNameTx !== void 0 ? _rpc$methodNameTx : 'createRPCMsgClient';
  var localname = getFileName(dir, (_rpc$filename = rpc.filename) !== null && _rpc$filename !== void 0 ? _rpc$filename : 'rpc');
  var obj = {};
  builder.rpcMsgClients.forEach(function (file) {
    // ADD all option
  ...
  var rpcast = (0, _ast.createScopedRpcFactory)(obj, methodName, 'MsgClientImpl' // make option later
  );
