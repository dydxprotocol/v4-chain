...
describe('MsgExecuteContract', () => {
  ...
  it('interface', () => {
    expectCode(createProtoType(context, 'MsgExecuteContract', getNestedProto(ref.traversed).MsgExecuteContract));
  });
  it('interface', () => {
    expectCode(createObjectWithMethods(context, 'MsgExecuteContract', getNestedProto(ref.traversed).MsgExecuteContract));
  });
});