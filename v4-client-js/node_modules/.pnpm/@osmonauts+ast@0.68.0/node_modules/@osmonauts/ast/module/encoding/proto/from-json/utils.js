...
export const fromJSON = {
  ...
  string(args) {
    ...
    return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [t.memberExpression(t.identifier('object'), t.identifier(objProp))]), t.callExpression(t.identifier('String'), [t.memberExpression(t.identifier('object'), t.identifier(objProp))]), getDefaultTSTypeFromProtoType(args.context, args.field, args.isOneOf)));
  },
  ...
  number(args) {
    ...
    args.context.addUtil('isSet');
    return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [t.memberExpression(t.identifier('object'), t.identifier(objProp))]), t.callExpression(t.identifier('Number'), [t.memberExpression(t.identifier('object'), t.identifier(objProp))]), getDefaultTSTypeFromProtoType(args.context, args.field, args.isOneOf)));
  },
  ...
  long(args) {
    ...
    return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [t.memberExpression(t.identifier('object'), t.identifier(objProp))]), t.callExpression(t.memberExpression(t.identifier('Long'), t.identifier('fromValue')), [t.memberExpression(t.identifier('object'), t.identifier(objProp))]), getDefaultTSTypeFromProtoType(args.context, args.field, args.isOneOf)));
  },
  ...
  array(args, expr) {
    ...
    return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.memberExpression(t.identifier('Array'), t.identifier('isArray')), [t.optionalMemberExpression(t.identifier('object'), t.identifier(objProp), false, true)]), t.callExpression(t.memberExpression(t.memberExpression(t.identifier('object'), t.identifier(objProp)), t.identifier('map')), [t.arrowFunctionExpression([identifier('e', t.tsTypeAnnotation(t.tsAnyKeyword()))], expr, false)]), t.arrayExpression([])));
  }
