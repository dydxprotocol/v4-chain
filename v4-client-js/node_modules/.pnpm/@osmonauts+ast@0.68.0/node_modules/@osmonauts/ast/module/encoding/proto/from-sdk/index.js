...
export const fromSDKMethodFields = (context, name, proto) => {
...
export const fromSDKMethod = (context, name, proto) => {
  ...
  return objectMethod('method', t.identifier('fromSDK'), [identifier(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(SDKTypeName))), false)], t.blockStatement([t.returnStatement(t.objectExpression(fields))]), false, false, false, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(name))));
};