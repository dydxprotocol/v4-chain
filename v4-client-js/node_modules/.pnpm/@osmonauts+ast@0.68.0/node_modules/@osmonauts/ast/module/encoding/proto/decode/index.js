...
export const decodeMethodFields = (context, name, proto) => {
...
export const decodeMethod = (context, name, proto) => {
  context.addUtil('_m0');
  let returnType = name; // decode can be coupled to API requests
  ...
  return objectMethod('method', t.identifier('decode'), [identifier('input', t.tsTypeAnnotation(t.tsUnionType([t.tsTypeReference(t.tsQualifiedName(t.identifier('_m0'), t.identifier('Reader')), null), t.tsTypeReference(t.identifier('Uint8Array'))])), false), identifier('length', t.tsTypeAnnotation(t.tsNumberKeyword()), true)], t.blockStatement([
  /*
  ...
  */
  ...
  t.variableDeclaration('const', [t.variableDeclarator(t.identifier('tag'), t.callExpression(t.memberExpression(t.identifier('reader'), t.identifier('uint32')), []))]), t.switchStatement(t.binaryExpression('>>>', t.identifier('tag'), t.numericLiteral(3)), [...decodeMethodFields(context, name, proto),
  /*
  default:
