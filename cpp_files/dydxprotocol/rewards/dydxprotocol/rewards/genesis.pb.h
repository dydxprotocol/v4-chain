...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dydxprotocol_2frewards_2fgenesis_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_dydxprotocol_2frewards_2fgenesis_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_dydxprotocol_2frewards_2fgenesis_2eproto
...
struct TableStruct_dydxprotocol_2frewards_2fgenesis_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_dydxprotocol_2frewards_2fgenesis_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template <>
::dydxprotocol::rewards::GenesisState* Arena::CreateMaybeMessage<::dydxprotocol::rewards::GenesisState>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class GenesisState final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:dydxprotocol.rewards.GenesisState) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "dydxprotocol.rewards.GenesisState";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:dydxprotocol.rewards.GenesisState)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dydxprotocol_2frewards_2fgenesis_2eproto;
};
...
inline const ::dydxprotocol::rewards::Params& GenesisState::_internal_params() const {
...
inline const ::dydxprotocol::rewards::Params& GenesisState::params() const {
  // @@protoc_insertion_point(field_get:dydxprotocol.rewards.GenesisState.params)
...
inline void GenesisState::unsafe_arena_set_allocated_params(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:dydxprotocol.rewards.GenesisState.params)
}
inline ::dydxprotocol::rewards::Params* GenesisState::release_params() {
  _impl_._has_bits_[0] &= ~0x00000001u;
...
inline ::dydxprotocol::rewards::Params* GenesisState::unsafe_arena_release_params() {
  // @@protoc_insertion_point(field_release:dydxprotocol.rewards.GenesisState.params)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::dydxprotocol::rewards::Params* temp = _impl_.params_;
  _impl_.params_ = nullptr;
  return temp;
}
inline ::dydxprotocol::rewards::Params* GenesisState::_internal_mutable_params() {
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::dydxprotocol::rewards::Params* GenesisState::mutable_params() {
  ::dydxprotocol::rewards::Params* _msg = _internal_mutable_params();
  // @@protoc_insertion_point(field_mutable:dydxprotocol.rewards.GenesisState.params)
  return _msg;
}
inline void GenesisState::set_allocated_params(::dydxprotocol::rewards::Params* params) {
  ...
  _impl_.params_ = params;
  // @@protoc_insertion_point(field_set_allocated:dydxprotocol.rewards.GenesisState.params)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_dydxprotocol_2frewards_2fgenesis_2eproto_2epb_2eh
