...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dydxprotocol_2frewards_2ftx_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_dydxprotocol_2frewards_2ftx_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_dydxprotocol_2frewards_2ftx_2eproto
...
struct TableStruct_dydxprotocol_2frewards_2ftx_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_dydxprotocol_2frewards_2ftx_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template <>
::dydxprotocol::rewards::MsgUpdateParams* Arena::CreateMaybeMessage<::dydxprotocol::rewards::MsgUpdateParams>(Arena*);
template <>
::dydxprotocol::rewards::MsgUpdateParamsResponse* Arena::CreateMaybeMessage<::dydxprotocol::rewards::MsgUpdateParamsResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class MsgUpdateParams final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:dydxprotocol.rewards.MsgUpdateParams) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "dydxprotocol.rewards.MsgUpdateParams";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:dydxprotocol.rewards.MsgUpdateParams)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dydxprotocol_2frewards_2ftx_2eproto;
};// -------------------------------------------------------------------

class MsgUpdateParamsResponse final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:dydxprotocol.rewards.MsgUpdateParamsResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "dydxprotocol.rewards.MsgUpdateParamsResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:dydxprotocol.rewards.MsgUpdateParamsResponse)
 private:
  class _Internal;
...
inline const std::string& MsgUpdateParams::authority() const {
  // @@protoc_insertion_point(field_get:dydxprotocol.rewards.MsgUpdateParams.authority)
...
inline PROTOBUF_ALWAYS_INLINE void MsgUpdateParams::set_authority(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:dydxprotocol.rewards.MsgUpdateParams.authority)
}
inline std::string* MsgUpdateParams::mutable_authority() {
  std::string* _s = _internal_mutable_authority();
  // @@protoc_insertion_point(field_mutable:dydxprotocol.rewards.MsgUpdateParams.authority)
  return _s;
}
...
inline std::string* MsgUpdateParams::release_authority() {
  // @@protoc_insertion_point(field_release:dydxprotocol.rewards.MsgUpdateParams.authority)
...
inline void MsgUpdateParams::set_allocated_authority(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:dydxprotocol.rewards.MsgUpdateParams.authority)
}
...
inline const ::dydxprotocol::rewards::Params& MsgUpdateParams::_internal_params() const {
...
inline const ::dydxprotocol::rewards::Params& MsgUpdateParams::params() const {
  // @@protoc_insertion_point(field_get:dydxprotocol.rewards.MsgUpdateParams.params)
...
inline void MsgUpdateParams::unsafe_arena_set_allocated_params(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:dydxprotocol.rewards.MsgUpdateParams.params)
}
inline ::dydxprotocol::rewards::Params* MsgUpdateParams::release_params() {
  _impl_._has_bits_[0] &= ~0x00000001u;
...
inline ::dydxprotocol::rewards::Params* MsgUpdateParams::unsafe_arena_release_params() {
  // @@protoc_insertion_point(field_release:dydxprotocol.rewards.MsgUpdateParams.params)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::dydxprotocol::rewards::Params* temp = _impl_.params_;
  _impl_.params_ = nullptr;
  return temp;
}
inline ::dydxprotocol::rewards::Params* MsgUpdateParams::_internal_mutable_params() {
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::dydxprotocol::rewards::Params* MsgUpdateParams::mutable_params() {
  ::dydxprotocol::rewards::Params* _msg = _internal_mutable_params();
  // @@protoc_insertion_point(field_mutable:dydxprotocol.rewards.MsgUpdateParams.params)
  return _msg;
}
inline void MsgUpdateParams::set_allocated_params(::dydxprotocol::rewards::Params* params) {
  ...
  _impl_.params_ = params;
  // @@protoc_insertion_point(field_set_allocated:dydxprotocol.rewards.MsgUpdateParams.params)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_dydxprotocol_2frewards_2ftx_2eproto_2epb_2eh
