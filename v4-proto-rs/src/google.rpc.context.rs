...
pub mod attribute_context {
    ...
    impl ::prost::Name for Peer {
        ...
        fn full_name() -> ::prost::alloc::string::String {
            "google.rpc.context.AttributeContext.Peer".into()
        }
    ...
    impl ::prost::Name for Api {
        ...
        const PACKAGE: &'static str = "google.rpc.context";
        fn full_name() -> ::prost::alloc::string::String {
            "google.rpc.context.AttributeContext.Api".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/google.rpc.context.AttributeContext.Api".into()
        }
    ...
    impl ::prost::Name for Auth {
        ...
        const PACKAGE: &'static str = "google.rpc.context";
        fn full_name() -> ::prost::alloc::string::String {
            "google.rpc.context.AttributeContext.Auth".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/google.rpc.context.AttributeContext.Auth".into()
        }
    ...
    impl ::prost::Name for Request {
        ...
        const PACKAGE: &'static str = "google.rpc.context";
        fn full_name() -> ::prost::alloc::string::String {
            "google.rpc.context.AttributeContext.Request".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/google.rpc.context.AttributeContext.Request".into()
        }
    ...
    impl ::prost::Name for Response {
        ...
        const PACKAGE: &'static str = "google.rpc.context";
        fn full_name() -> ::prost::alloc::string::String {
            "google.rpc.context.AttributeContext.Response".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/google.rpc.context.AttributeContext.Response".into()
        }
    ...
    impl ::prost::Name for Resource {
        ...
        const PACKAGE: &'static str = "google.rpc.context";
        fn full_name() -> ::prost::alloc::string::String {
            "google.rpc.context.AttributeContext.Resource".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/google.rpc.context.AttributeContext.Resource".into()
        }
...
impl ::prost::Name for AttributeContext {
    ...
    const PACKAGE: &'static str = "google.rpc.context";
    fn full_name() -> ::prost::alloc::string::String {
        "google.rpc.context.AttributeContext".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/google.rpc.context.AttributeContext".into()
    }
