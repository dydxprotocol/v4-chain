...
describe('Wallet store', () => {
  ...
  it('Shoudl not allow duplicate refree address', async () => {
    await AffiliateReferredUsersTable.create(defaultAffiliateReferredUser);
  ...
  it('Successfully finds all affiliate referee pairs', async () => {
  ...
  it('Successfully finds affiliate referee pairs by affiliate address', async () => {
    const entry1: AffiliateReferredUsersCreateObject = {
      affiliateAddress: 'affiliate_address1',
      refereeAddress: 'referee_address1',
      referredAtBlock: 1,
