import { IsoString, OrderTable, SubaccountTable } from '@klyraprotocol-indexer/postgres';
...
export const address: string = 'klyraprotocol174e000tqwvszgjxs7yaj844e0m9s6f0m45ws7q';
