import { OrderTable, PerpetualMarketFromDatabase, protocolTranslations } from '@klyraprotocol-indexer/postgres';
import { IndexerOrder, RedisOrder, RedisOrder_TickerType } from '@klyraprotocol-indexer/v4-protos';
