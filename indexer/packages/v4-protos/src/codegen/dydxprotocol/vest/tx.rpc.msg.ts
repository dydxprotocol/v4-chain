...
export class MsgClientImpl implements Msg {
  ...
  setVestEntry(request: MsgSetVestEntry): Promise<MsgSetVestEntryResponse> {
    ...
    return promise.then(data => MsgSetVestEntryResponse.decode(new BinaryReader(data)));
  }
  deleteVestEntry(request: MsgDeleteVestEntry): Promise<MsgDeleteVestEntryResponse> {
    ...
    return promise.then(data => MsgDeleteVestEntryResponse.decode(new BinaryReader(data)));
  }
}