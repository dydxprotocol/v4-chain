...
import { DeleveragingEventV2 } from '@dydxprotocol-indexer/v4-protos';
...
export class DeleveragingHandlerV2 extends AbstractOrderFillHandler<DeleveragingEventV2> {
  eventType: string = 'DeleveragingEventV2';
  ...
  public getParallelizationIds(): string[] {
    ...
    if (perpetualMarket === undefined) {
      logger.error({
        at: 'DeleveragingHandlerV2#internalHandle',
