/**
  ...
  Returns: JSON object containing fields:
    - subaccount: The upserted subaccount in subaccount-model format (https://github.com/dydxprotocol/indexer/blob/cc70982/packages/postgres/src/models/subaccount-model.ts).
    - perpetual_positions: A JSON array of upserted perpetual positions in perpetual-position-model format (https://github.com/dydxprotocol/indexer/blob/cc70982/packages/postgres/src/models/perpetual-position-model.ts).
    - asset_positions: A JSON array of upserted asset positions in asset-position-model format (https://github.com/dydxprotocol/indexer/blob/cc70982/packages/postgres/src/models/asset-position-model.ts).
*/
