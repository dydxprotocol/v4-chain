/**
  ...
  Returns: JSON object containing fields:
    - asset: The existing asset in asset-model format (https://github.com/dydxprotocol/indexer/blob/cc70982/packages/postgres/src/models/asset-model.ts).
    - transfer: The new transfer in transfer-model format (https://github.com/dydxprotocol/indexer/blob/cc70982/packages/postgres/src/models/transfer-model.ts).
*/
