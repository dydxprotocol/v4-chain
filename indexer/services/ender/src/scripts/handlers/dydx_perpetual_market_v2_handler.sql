CREATE OR REPLACE FUNCTION klyra_perpetual_market_v2_handler(event_data jsonb) RETURNS jsonb AS $$
/**
  Parameters:
...
BEGIN
    ...
    perpetual_market_record."marketType" = klyra_protocol_market_type_to_perpetual_market_type(event_data->'marketType');
