        ...
        orders: [
          {
            ...
            routerFeeSubaccountOwner: removedRedisOrder.order!.routerSubaccountId?.owner,
            routerFeeSubaccountNumber: removedRedisOrder.order!.routerSubaccountId?.number.toString(),
            triggerPrice,
          },
        ],
      };
