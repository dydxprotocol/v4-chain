...
describe('vault-controller#V4', () => {
  ...
  const vaultPnlStartDatePrev: string = config.VAULT_START_PNL_DATE;
  ...
  describe('GET /v1', () => {
    beforeEach(async () => {
      ...
      config.VAULT_START_PNL_DATE = '2020-01-01T00:00:00Z';
    ...
    it.each([
      ...
      ['start date adjust PnL', '?resolution=hour', [1, 2, 3, 4], 4, '2024-01-01T00:00:00Z'],
      ...
      if (startDate !== undefined) {
        config.VAULT_START_PNL_DATE = startDate;
      }
