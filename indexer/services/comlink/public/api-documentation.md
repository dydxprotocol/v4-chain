...
r = requests.get(f'{baseURL}/vault/v1/v1/megavault/positions', headers = headers)
...
fetch(`${baseURL}/vault/v1/v1/megavault/positions`,
{
  method: 'GET',
...
`GET /vault/v1/v1/megavault/positions`
