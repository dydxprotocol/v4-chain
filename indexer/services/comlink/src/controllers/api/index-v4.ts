...
import HistoricalFundingPaymentController from './v4/historical-funding-payment-controller';
...
router.use('/historicalFundingPayment', HistoricalFundingPaymentController);
